// CacheStorage_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case HAS_ORDINAL: {
                        ...
                        getImpl().has(data.cacheName, data.traceId, new CacheStorageHasResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
                    ...
                    case DELETE_ORDINAL: {
                        ...
                        getImpl().delete(data.cacheName, data.traceId, new CacheStorageDeleteResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
                    ...
                    case KEYS_ORDINAL: {
                        ...
                        CacheStorageKeysParams data =
                                CacheStorageKeysParams.deserialize(messageWithHeader.getPayload());

                        getImpl().keys(data.traceId, new CacheStorageKeysResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
                    ...
                    case OPEN_ORDINAL: {
                        ...
                        getImpl().open(data.cacheName, data.traceId, new CacheStorageOpenResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
