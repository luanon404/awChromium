// FirstPartySetsCacheFilter.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class FirstPartySetsCacheFilter extends org.chromium.mojo.bindings.Struct {
    ...
    public static FirstPartySetsCacheFilter deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static FirstPartySetsCacheFilter decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        FirstPartySetsCacheFilter result;
        try {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.filter == null) {
            ...
            int index0 = 0;
            for (java.util.Map.Entry<SchemefulSite, Long> entry0 : this.filter.entrySet()) {
