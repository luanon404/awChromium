...
class WebSocketHandshakeClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<WebSocketHandshakeClient, WebSocketHandshakeClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<WebSocketHandshakeClient, WebSocketHandshakeClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements WebSocketHandshakeClient.Proxy {
        ...
        public void onOpeningHandshakeStarted(WebSocketHandshakeRequest request) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_OPENING_HANDSHAKE_STARTED_ORDINAL)));
        ...
        public void onFailure(String message, int netError, int responseCode) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_FAILURE_ORDINAL)));

        }


        @Override
        public void onConnectionEstablished(WebSocket socket, org.chromium.mojo.bindings.InterfaceRequest<WebSocketClient> clientReceiver, WebSocketHandshakeResponse response, org.chromium.mojo.system.DataPipe.ConsumerHandle readable, org.chromium.mojo.system.DataPipe.ProducerHandle writable) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(WebSocketHandshakeClient_Internal.MANAGER, messageWithHeader);


                    case ON_OPENING_HANDSHAKE_STARTED_ORDINAL: {

                        WebSocketHandshakeClientOnOpeningHandshakeStartedParams data = WebSocketHandshakeClientOnOpeningHandshakeStartedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_FAILURE_ORDINAL: {
                        ...
                        WebSocketHandshakeClientOnFailureParams data = WebSocketHandshakeClientOnFailureParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), WebSocketHandshakeClient_Internal.MANAGER, messageWithHeader, receiver);
