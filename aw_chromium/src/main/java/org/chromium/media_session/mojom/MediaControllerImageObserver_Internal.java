// MediaControllerImageObserver_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class MediaControllerImageObserver_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<MediaControllerImageObserver, MediaControllerImageObserver.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<MediaControllerImageObserver, MediaControllerImageObserver.Proxy>() {
        ...
        @Override
        public Stub buildStub(org.chromium.mojo.system.Core core, MediaControllerImageObserver impl) {
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<MediaControllerImageObserver> {

        Stub(org.chromium.mojo.system.Core core, MediaControllerImageObserver impl) {
            super(core, impl);
        }
    ...
    static final class MediaControllerImageObserverMediaControllerImageChangedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static MediaControllerImageObserverMediaControllerImageChangedParams deserialize(org.chromium.mojo.bindings.Message message) {
        ...
        public static MediaControllerImageObserverMediaControllerImageChangedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
