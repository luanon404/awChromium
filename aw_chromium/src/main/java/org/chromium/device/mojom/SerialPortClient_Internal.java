...
class SerialPortClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<SerialPortClient, SerialPortClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<SerialPortClient, SerialPortClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements SerialPortClient.Proxy {
        ...
        public void onSendError(int error) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_SEND_ERROR_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(SerialPortClient_Internal.MANAGER, messageWithHeader);


                    case ON_READ_ERROR_ORDINAL: {

                        SerialPortClientOnReadErrorParams data = SerialPortClientOnReadErrorParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_SEND_ERROR_ORDINAL: {
                        ...
                        SerialPortClientOnSendErrorParams data = SerialPortClientOnSendErrorParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), SerialPortClient_Internal.MANAGER, messageWithHeader, receiver);
