...
@IntDef({PopupItemId.AUTOCOMPLETE_ENTRY, PopupItemId.ADDRESS_ENTRY, PopupItemId.FILL_FULL_ADDRESS, PopupItemId.FILL_FULL_NAME, PopupItemId.FILL_EVERYTHING_FROM_ADDRESS_PROFILE, PopupItemId.FILL_FULL_PHONE_NUMBER, PopupItemId.TITLE, PopupItemId.EDIT_ADDRESS_PROFILE, PopupItemId.DELETE_ADDRESS_PROFILE, PopupItemId.AUTOFILL_OPTIONS, PopupItemId.COMPOSE, PopupItemId.DATALIST_ENTRY, PopupItemId.PASSWORD_ENTRY, PopupItemId.USERNAME_ENTRY, PopupItemId.ALL_SAVED_PASSWORDS_ENTRY, PopupItemId.GENERATE_PASSWORD_ENTRY, PopupItemId.SHOW_ACCOUNT_CARDS, PopupItemId.PASSWORD_ACCOUNT_STORAGE_OPT_IN, PopupItemId.PASSWORD_ACCOUNT_STORAGE_OPT_IN_AND_GENERATE, PopupItemId.ACCOUNT_STORAGE_PASSWORD_ENTRY, PopupItemId.ACCOUNT_STORAGE_USERNAME_ENTRY, PopupItemId.PASSWORD_ACCOUNT_STORAGE_RE_SIGNIN, PopupItemId.PASSWORD_ACCOUNT_STORAGE_EMPTY, PopupItemId.CREDIT_CARD_ENTRY, PopupItemId.INSECURE_CONTEXT_PAYMENT_DISABLED_MESSAGE, PopupItemId.SCAN_CREDIT_CARD, PopupItemId.VIRTUAL_CREDIT_CARD_ENTRY, PopupItemId.IBAN_ENTRY, PopupItemId.CREATE_NEW_PLUS_ADDRESS, PopupItemId.FILL_EXISTING_PLUS_ADDRESS, PopupItemId.MERCHANT_PROMO_CODE_ENTRY, PopupItemId.SEE_PROMO_CODE_DETAILS, PopupItemId.WEBAUTHN_CREDENTIAL, PopupItemId.WEBAUTHN_SIGN_IN_WITH_ANOTHER_DEVICE, PopupItemId.FIELD_BY_FIELD_FILLING, PopupItemId.SEPARATOR, PopupItemId.CLEAR_FORM, PopupItemId.MIXED_FORM_MESSAGE, PopupItemId.MAX_VALUE})
...
public @interface PopupItemId {
    ...
    int MAX_VALUE = MIXED_FORM_MESSAGE;
}
