...
RequestMouseLock_Response callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case IME_COMPOSITION_RANGE_CHANGED_ORDINAL: {
                        ...
                        getImpl().imeCompositionRangeChanged(data.range, data.characterBounds, data.lineBounds);
                        return true;
                    }
    ...
    static final class WidgetInputHandlerHostImeCompositionRangeChangedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public org.chromium.gfx.mojom.Rect[] characterBounds;
        public org.chromium.gfx.mojom.Rect[] lineBounds;
            ...
            try {
                ...
                result = new WidgetInputHandlerHostImeCompositionRangeChangedParams(elementsOrVersion);
                    ...
                    if (decoder1 == null) {
                        ...
                        result.characterBounds = new org.chromium.gfx.mojom.Rect[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.characterBounds[i1] = org.chromium.gfx.mojom.Rect.decode(decoder2);
                        }
                    }
                    }
                    {
                    ...
                    if (decoder1 == null) {
                        ...
                        org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                        result.lineBounds = new org.chromium.gfx.mojom.Rect[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                            
                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.lineBounds[i1] = org.chromium.gfx.mojom.Rect.decode(decoder2);
                        }
                    }
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.characterBounds == null) {
                encoder0.encodeNullPointer(16, true);
            } else {
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.characterBounds.length, 16, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                for (int i0 = 0; i0 < this.characterBounds.length; ++i0) {
                    
                    encoder1.encode(this.characterBounds[i0], org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i0, false);
                }
            }
            ...
            if (this.lineBounds == null) {
                ...
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.lineBounds.length, 24, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                for (int i0 = 0; i0 < this.lineBounds.length; ++i0) {
                    
                    encoder1.encode(this.lineBounds[i0], org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i0, false);
                }
            }
        }
    }
