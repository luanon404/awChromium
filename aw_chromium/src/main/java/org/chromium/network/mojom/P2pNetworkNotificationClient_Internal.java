// P2pNetworkNotificationClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class P2pNetworkNotificationClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<P2pNetworkNotificationClient, P2pNetworkNotificationClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<P2pNetworkNotificationClient, P2pNetworkNotificationClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements P2pNetworkNotificationClient.Proxy {
        ...
        public void networkListChanged(NetworkInterface[] networks, IpAddress defaultIpv4LocalAddress, IpAddress defaultIpv6LocalAddress) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(NETWORK_LIST_CHANGED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(P2pNetworkNotificationClient_Internal.MANAGER, messageWithHeader);
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), P2pNetworkNotificationClient_Internal.MANAGER, messageWithHeader, receiver);
