...
public class AdditionalNavigationParams {
    ...
    public AdditionalNavigationParams(UnguessableToken initiatorFrameToken, int initiatorProcessId, @Nullable UnguessableToken attributionSrcToken, long attributionRuntimeFeatures) {
