// CanMakePaymentEventData.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class CanMakePaymentEventData extends org.chromium.mojo.bindings.Struct {
    ...
    public static CanMakePaymentEventData deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static CanMakePaymentEventData deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static CanMakePaymentEventData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        CanMakePaymentEventData result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new CanMakePaymentEventData(elementsOrVersion);
            {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.methodData == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.methodData.length, 24, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
