// AuctionAdConfigMaybePromiseJson.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class AuctionAdConfigMaybePromiseJson extends org.chromium.mojo.bindings.Union {
    ...
    public static AuctionAdConfigMaybePromiseJson deserialize(org.chromium.mojo.bindings.Message message) {
        return decode(new org.chromium.mojo.bindings.Decoder(message).decoderForSerializedUnion(), 0);
    }

    public static final AuctionAdConfigMaybePromiseJson decode(org.chromium.mojo.bindings.Decoder decoder0, int offset) {
        ...
        switch (dataHeader.elementsOrVersion) {
            ...
            case Tag.Value: {
                ...
                result.mValue = decoder0.readString(offset + org.chromium.mojo.bindings.DataHeader.HEADER_SIZE, true);
