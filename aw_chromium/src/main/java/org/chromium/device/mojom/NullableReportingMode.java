// NullableReportingMode.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class NullableReportingMode extends org.chromium.mojo.bindings.Struct {
    ...
    private NullableReportingMode(int version) {
        super(STRUCT_SIZE, version);
    }

    public NullableReportingMode() {
        this(0);
    }

    public static NullableReportingMode deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static NullableReportingMode decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        NullableReportingMode result;
        try {
