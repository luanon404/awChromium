...
OpenUrlParams params) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(OPEN_URL_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case OPEN_URL_ORDINAL: {

                        RemoteFrameHostOpenUrlParams data =
                                RemoteFrameHostOpenUrlParams.deserialize(messageWithHeader.getPayload());

                        getImpl().openUrl(data.params);
                        return true;
                    }
    ...
    static final class RemoteFrameHostOpenUrlParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteFrameHostOpenUrlParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static RemoteFrameHostOpenUrlParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static RemoteFrameHostOpenUrlParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            RemoteFrameHostOpenUrlParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new RemoteFrameHostOpenUrlParams(elementsOrVersion);
                    {
