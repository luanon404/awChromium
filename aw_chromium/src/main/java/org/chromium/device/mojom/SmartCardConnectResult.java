// SmartCardConnectResult.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class SmartCardConnectResult extends org.chromium.mojo.bindings.Union {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder0, int offset) {
        ...
        switch (mTag) {
            case Tag.Success: {
                ...
                encoder0.encode(this.mSuccess, offset + 8, false);
                break;
            }
            case Tag.Error: {
    ...
    public static SmartCardConnectResult deserialize(org.chromium.mojo.bindings.Message message) {
        return decode(new org.chromium.mojo.bindings.Decoder(message).decoderForSerializedUnion(), 0);
    }

    public static final SmartCardConnectResult decode(org.chromium.mojo.bindings.Decoder decoder0, int offset) {
