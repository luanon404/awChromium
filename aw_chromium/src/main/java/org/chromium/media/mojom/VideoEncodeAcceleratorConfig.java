...
public final class VideoEncodeAcceleratorConfig extends org.chromium.mojo.bindings.Struct {
    ...
    public static final class ContentType {
        ...
        @IntDef({ContentType.CAMERA, ContentType.DISPLAY})
    ...
    public static final class StorageType {
        ...
        @IntDef({
                ...
                StorageType.SHMEM, StorageType.GPU_MEMORY_BUFFER})
        public @interface EnumType {
        }
    ...
    public static final class EncoderType {
        ...
        @IntDef({
                ...
                EncoderType.HARDWARE, EncoderType.SOFTWARE, EncoderType.NO_PREFERENCE})
        public @interface EnumType {
        }
