...
public class LicenseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String licenseUri = String.format("content://%s.%s", packageName, LICENSES_URI_SUFFIX);
        ...
        final int titleId = getResources().getIdentifier("license_activity_title", "string", packageName);
        if (titleId != 0) {
