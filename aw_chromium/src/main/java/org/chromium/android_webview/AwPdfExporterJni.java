...
class AwPdfExporterJni implements AwPdfExporter.Natives {
    ...
    public static final JniStaticTestMocker<AwPdfExporter.Natives> TEST_HOOKS = new JniStaticTestMocker<AwPdfExporter.Natives>() {
        @Override
    ...
    public static AwPdfExporter.Natives get() {
        if (GEN_JNI.TESTING_ENABLED) {
            ...
            if (GEN_JNI.REQUIRE_MOCK) {
                throw new UnsupportedOperationException("No mock found for the native implementation of AwPdfExporter.Natives. " + "The current configuration requires implementations be mocked.");
            }
        }
