// WebrtcVideoStats.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class WebrtcVideoStats extends org.chromium.mojo.bindings.Struct {
    ...
    private WebrtcVideoStats(int version) {
        ...
        this.framesProcessed = (int) 0;
        this.keyFramesProcessed = (int) 0;
        this.p99ProcessingTimeMs = (float) 0;
    }
    ...
    public static WebrtcVideoStats deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static WebrtcVideoStats decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        WebrtcVideoStats result;
        try {
