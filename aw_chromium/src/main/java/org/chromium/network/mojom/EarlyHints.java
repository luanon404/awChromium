// EarlyHints.java is auto generated by mojom_bindings_generator.py, do not edit
...
// For:
//     services/network/public/mojom/early_hints.mojom
//
...
public final class EarlyHints extends org.chromium.mojo.bindings.Struct {
    ...
    public static EarlyHints deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static EarlyHints deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static EarlyHints decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new EarlyHints(elementsOrVersion);
                {
