...
public final class UrlResponseHead extends org.chromium.mojo.bindings.Struct {
    ...
    private UrlResponseHead(int version) {
        ...
        this.navigationDeliveryType = (int) NavigationDeliveryType.DEFAULT;
        ...
        this.didUseSharedDictionary = (boolean) false;
    }
    ...
    public static UrlResponseHead decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            }
            {
                ...
                result.hasRangeRequested = decoder0.readBoolean(53, 7);
            }
            {
            ...
            }
            {
                ...
                result.hasAuthorizationCoveredByWildcardOnPreflight = decoder0.readBoolean(54, 1);
            }
            {

                result.requestIncludeCredentials = decoder0.readBoolean(54, 2);
            }
            {

                result.didUseSharedDictionary = decoder0.readBoolean(54, 3);
            }
            {
            ...
            }
            {
                ...
                result.encodedBodyLength = EncodedBodyLength.decode(decoder1);
            }
            {
            ...
            }
            {
                ...
                result.alternateProtocolUsage = decoder0.readInt(92);
            ...
            }
            {
                ...
                result.clientAddressSpace = decoder0.readInt(112);
            ...
            }
            {
                ...
                result.responseAddressSpace = decoder0.readInt(116);
            ...
            }
            {
                ...
                result.navigationDeliveryType = decoder0.readInt(120);
                NavigationDeliveryType.validate(result.navigationDeliveryType);
                result.navigationDeliveryType = NavigationDeliveryType.toKnownValue(result.navigationDeliveryType);
            }
            {

                result.serviceWorkerResponseSource = decoder0.readInt(124);
            ...
            }
            {
                ...
                {
                    org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                    result.triggerVerifications = new TriggerVerification[si1.elementsOrVersion];
                    for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {

                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                        result.triggerVerifications[i1] = TriggerVerification.decode(decoder2);
                    }
                }
            }
            {

                result.privateNetworkAccessPreflightResult = decoder0.readInt(248);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.hasRangeRequested, 53, 7);

        encoder0.encode(this.timingAllowPassed, 54, 0);

        encoder0.encode(this.hasAuthorizationCoveredByWildcardOnPreflight, 54, 1);

        encoder0.encode(this.requestIncludeCredentials, 54, 2);

        encoder0.encode(this.didUseSharedDictionary, 54, 3);

        encoder0.encode(this.contentLength, 56);

        encoder0.encode(this.encodedDataLength, 64);

        encoder0.encode(this.encodedBodyLength, 72, true);

        encoder0.encode(this.loadTiming, 80, false);

        encoder0.encode(this.connectionInfo, 88);

        encoder0.encode(this.alternateProtocolUsage, 92);

        encoder0.encode(this.alpnNegotiatedProtocol, 96, false);

        encoder0.encode(this.remoteEndpoint, 104, false);

        encoder0.encode(this.clientAddressSpace, 112);

        encoder0.encode(this.responseAddressSpace, 116);

        encoder0.encode(this.navigationDeliveryType, 120);

        encoder0.encode(this.serviceWorkerResponseSource, 124);

        encoder0.encode(this.proxyServer, 128, false);

        if (this.urlListViaServiceWorker == null) {
            encoder0.encodeNullPointer(136, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.urlListViaServiceWorker.length, 136, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        encoder0.encode(this.certStatus, 148);
        ...
        if (this.corsExposedHeaderNames == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.corsExposedHeaderNames.length, 176, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        encoder0.encode(this.recursivePrefetchToken, 216, true);

        if (this.dnsAliases == null) {
            encoder0.encodeNullPointer(224, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.dnsAliases.length, 224, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        encoder0.encode(this.webBundleUrl, 232, false);

        if (this.triggerVerifications == null) {
            encoder0.encodeNullPointer(240, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.triggerVerifications.length, 240, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
            for (int i0 = 0; i0 < this.triggerVerifications.length; ++i0) {

                encoder1.encode(this.triggerVerifications[i0], org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i0, false);
            }
        }

        encoder0.encode(this.privateNetworkAccessPreflightResult, 248);
    }
}