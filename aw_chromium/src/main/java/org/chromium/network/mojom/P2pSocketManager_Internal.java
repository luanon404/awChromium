...
class P2pSocketManager_Internal {
    ...
    static final class P2pSocketManagerGetHostAddressWithFamilyParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static P2pSocketManagerGetHostAddressWithFamilyParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static P2pSocketManagerGetHostAddressWithFamilyParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
    ...
    static final class P2pSocketManagerGetHostAddressWithFamilyResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static P2pSocketManagerGetHostAddressWithFamilyResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static P2pSocketManagerGetHostAddressWithFamilyResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
    ...
    static class P2pSocketManagerGetHostAddressWithFamilyResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable implements org.chromium.mojo.bindings.MessageReceiver {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                P2pSocketManagerGetHostAddressWithFamilyResponseParams response = P2pSocketManagerGetHostAddressWithFamilyResponseParams.deserialize(messageWithHeader.getPayload());
    ...
    static class P2pSocketManagerGetHostAddressWithFamilyResponseParamsProxyToResponder implements P2pSocketManager.GetHostAddressWithFamily_Response {
        ...
        @Override
        public void call(IpAddress[] addresses) {
            P2pSocketManagerGetHostAddressWithFamilyResponseParams _response = new P2pSocketManagerGetHostAddressWithFamilyResponseParams();
