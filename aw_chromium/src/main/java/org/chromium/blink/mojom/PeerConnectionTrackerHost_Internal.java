...
int requestId, boolean audio, boolean video, String audioConstraints, String videoConstraints) {
            ...
            PeerConnectionTrackerHostGetDisplayMediaParams _message = new PeerConnectionTrackerHostGetDisplayMediaParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(GET_DISPLAY_MEDIA_ORDINAL)));
...
int requestId, String streamId, String audioTrackInfo, String videoTrackInfo) {
            ...
            PeerConnectionTrackerHostGetDisplayMediaSuccessParams _message = new PeerConnectionTrackerHostGetDisplayMediaSuccessParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(GET_DISPLAY_MEDIA_SUCCESS_ORDINAL)));

        }


        @Override
        public void getDisplayMediaFailure(
int requestId, String error, String errorMessage) {

            PeerConnectionTrackerHostGetDisplayMediaFailureParams _message = new PeerConnectionTrackerHostGetDisplayMediaFailureParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(GET_DISPLAY_MEDIA_FAILURE_ORDINAL)));
...
int lid, org.chromium.mojo_base.mojom.ListValue value) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_DISPLAY_MEDIA_ORDINAL: {

                        PeerConnectionTrackerHostGetDisplayMediaParams data =
                                PeerConnectionTrackerHostGetDisplayMediaParams.deserialize(messageWithHeader.getPayload());

                        getImpl().getDisplayMedia(data.requestId, data.audio, data.video, data.audioConstraints, data.videoConstraints);
                        return true;
                    }
                    ...
                    case GET_DISPLAY_MEDIA_SUCCESS_ORDINAL: {

                        PeerConnectionTrackerHostGetDisplayMediaSuccessParams data =
                                PeerConnectionTrackerHostGetDisplayMediaSuccessParams.deserialize(messageWithHeader.getPayload());

                        getImpl().getDisplayMediaSuccess(data.requestId, data.streamId, data.audioTrackInfo, data.videoTrackInfo);
                        return true;
                    }
                    ...
                    case GET_DISPLAY_MEDIA_FAILURE_ORDINAL: {

                        PeerConnectionTrackerHostGetDisplayMediaFailureParams data =
                                PeerConnectionTrackerHostGetDisplayMediaFailureParams.deserialize(messageWithHeader.getPayload());

                        getImpl().getDisplayMediaFailure(data.requestId, data.error, data.errorMessage);
                        return true;
                    }
    ...
    static final class PeerConnectionTrackerHostGetDisplayMediaParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PeerConnectionTrackerHostGetDisplayMediaParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PeerConnectionTrackerHostGetDisplayMediaParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PeerConnectionTrackerHostGetDisplayMediaParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PeerConnectionTrackerHostGetDisplayMediaParams(elementsOrVersion);
                    {
    ...
    static final class PeerConnectionTrackerHostGetDisplayMediaSuccessParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PeerConnectionTrackerHostGetDisplayMediaSuccessParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PeerConnectionTrackerHostGetDisplayMediaSuccessParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PeerConnectionTrackerHostGetDisplayMediaSuccessParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PeerConnectionTrackerHostGetDisplayMediaSuccessParams(elementsOrVersion);
                    {
    ...
    static final class PeerConnectionTrackerHostGetDisplayMediaFailureParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PeerConnectionTrackerHostGetDisplayMediaFailureParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PeerConnectionTrackerHostGetDisplayMediaFailureParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PeerConnectionTrackerHostGetDisplayMediaFailureParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PeerConnectionTrackerHostGetDisplayMediaFailureParams(elementsOrVersion);
                    {
