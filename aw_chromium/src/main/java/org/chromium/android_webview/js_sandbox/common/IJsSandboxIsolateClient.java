...
public interface IJsSandboxIsolateClient extends android.os.IInterface {
     ...
     */
    class Default implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateClient {
        /**
     ...
     */
    abstract class Stub extends android.os.Binder implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateClient {
        /**
     ...
     * @param message Unstructured information about the termination. May be null.
     */
    void onTerminated(int status, java.lang.String message) throws android.os.RemoteException;
}
