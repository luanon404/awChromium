 ...
 */
public class ViewResourceAdapter implements DynamicResource, OnLayoutChangeListener, CaptureObserver {
    /**
    ...
    public interface CaptureMechanism {
         ...
         */
        boolean startBitmapCapture(View view, Rect dirtyRect, float scale, CaptureObserver observer, Callback<Bitmap> onBitmapCapture);
    }
