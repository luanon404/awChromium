...
public final class PermissionsPolicyFeature {
    ...
    @IntDef({
        ...
        PermissionsPolicyFeature.WINDOW_MANAGEMENT,
        PermissionsPolicyFeature.CLIENT_HINT_UA_BITNESS,
        PermissionsPolicyFeature.CLIENT_HINT_VIEWPORT_HEIGHT,
        PermissionsPolicyFeature.KEYBOARD_MAP,
        PermissionsPolicyFeature.RUN_AD_AUCTION,
        PermissionsPolicyFeature.JOIN_AD_INTEREST_GROUP,
        PermissionsPolicyFeature.CLIENT_HINT_UA_FULL_VERSION_LIST,
        PermissionsPolicyFeature.CLIENT_HINT_UA_WO_W64,
        PermissionsPolicyFeature.BROWSING_TOPICS,
        PermissionsPolicyFeature.BROWSING_TOPICS_BACKWARD_COMPATIBLE,
        PermissionsPolicyFeature.CLIENT_HINT_SAVE_DATA,
        PermissionsPolicyFeature.LOCAL_FONTS,
        PermissionsPolicyFeature.BLUETOOTH,
        PermissionsPolicyFeature.IDENTITY_CREDENTIALS_GET,
        PermissionsPolicyFeature.SHARED_STORAGE,
        PermissionsPolicyFeature.UNLOAD,
        PermissionsPolicyFeature.CLIENT_HINT_PREFERS_REDUCED_MOTION,
        PermissionsPolicyFeature.COMPUTE_PRESSURE,
        PermissionsPolicyFeature.SMART_CARD,
        PermissionsPolicyFeature.SHARED_STORAGE_SELECT_URL,
        PermissionsPolicyFeature.PRIVATE_AGGREGATION,
        PermissionsPolicyFeature.PRIVATE_STATE_TOKEN_ISSUANCE,
        PermissionsPolicyFeature.CLIENT_HINT_UA_FORM_FACTOR,
        PermissionsPolicyFeature.CLIENT_HINT_PREFERS_REDUCED_TRANSPARENCY})
