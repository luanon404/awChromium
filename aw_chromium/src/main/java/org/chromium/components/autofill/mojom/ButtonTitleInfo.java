// ButtonTitleInfo.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class ButtonTitleInfo extends org.chromium.mojo.bindings.Struct {
    ...
    private ButtonTitleInfo(int version) {
        super(STRUCT_SIZE, version);
    }

    public ButtonTitleInfo() {
        this(0);
    }

    public static ButtonTitleInfo deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ButtonTitleInfo deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    public static ButtonTitleInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        ButtonTitleInfo result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new ButtonTitleInfo(elementsOrVersion);
                {
