// SiteForCookies.java is auto generated by mojom_bindings_generator.py, do not edit
...
// For:
//     services/network/public/mojom/site_for_cookies.mojom
//
...
public final class SiteForCookies extends org.chromium.mojo.bindings.Struct {
    ...
    public static SiteForCookies deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static SiteForCookies deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static SiteForCookies decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        SiteForCookies result;
        try {
