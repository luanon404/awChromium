...
EncoderStatus status) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(NOTIFY_ERROR_STATUS_ORDINAL)));
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case NOTIFY_ERROR_STATUS_ORDINAL: {
                        ...
                        VideoEncodeAcceleratorClientNotifyErrorStatusParams data =
                                VideoEncodeAcceleratorClientNotifyErrorStatusParams.deserialize(messageWithHeader.getPayload());
