// RequestBody.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class RequestBody extends org.chromium.mojo.bindings.Struct {
    ...
    public static RequestBody deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static RequestBody deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static RequestBody decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new RequestBody(elementsOrVersion);
                {
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                {
                    ...
                    for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                        ...
                        result.elements[i1] = Element.decode(decoder1, org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + 
