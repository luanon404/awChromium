...
public final class CookieManagerParams extends org.chromium.mojo.bindings.Struct {
    ...
    public java.util.Map<Integer, org.chromium.content_settings.mojom.ContentSettingPatternSource[]> contentSettings;
    ...
    public static CookieManagerParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new CookieManagerParams(elementsOrVersion);
                ...
                result.mitigationsEnabledFor3pcd = decoder0.readBoolean(8, 2);
                }
                {
                    
                result.allowFileSchemeCookies = decoder0.readBoolean(8, 3);
                }
                {
                    ...
                    org.chromium.content_settings.mojom.ContentSettingPatternSource[][] values0;
                    {
                        ...
                        keys0 = decoder1.readInts(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                        {
                            for (int i2 = 0; i2 < keys0.length; ++i2) {
                                org.chromium.content_settings.mojom.ContentSettingsType.validate(keys0[i2]);
                            }
                        }
                    }
                    {
                        ...
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE, false);
                        {
                            ...
                            values0 = new org.chromium.content_settings.mojom.ContentSettingPatternSource[si2.elementsOrVersion][];
                            for (int i2 = 0; i2 < si2.elementsOrVersion; ++i2) {
                                ...
                                org.chromium.mojo.bindings.Decoder decoder3 = decoder2.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i2, false);
                                {
                                    ...
                                    values0[i2] = new org.chromium.content_settings.mojom.ContentSettingPatternSource[si3.elementsOrVersion];
                                    for (int i3 = 0; i3 < si3.elementsOrVersion; ++i3) {
                                        ...
                                        values0[i2][i3] = org.chromium.content_settings.mojom.ContentSettingPatternSource.decode(decoder4);
                                    }
                                }
                            }
                        }
                    }
                    result.contentSettings = new java.util.HashMap<Integer, org.chromium.content_settings.mojom.ContentSettingPatternSource[]>();
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.mitigationsEnabledFor3pcd, 8, 2);
        
        encoder0.encode(this.allowFileSchemeCookies, 8, 3);
        ...
        if (this.contentSettings == null) {
            ...
            org.chromium.content_settings.mojom.ContentSettingPatternSource[][] values0 = new org.chromium.content_settings.mojom.ContentSettingPatternSource[size0][];
            int index0 = 0;
            for (java.util.Map.Entry<Integer, org.chromium.content_settings.mojom.ContentSettingPatternSource[]> entry0 : this.contentSettings.entrySet()) {
