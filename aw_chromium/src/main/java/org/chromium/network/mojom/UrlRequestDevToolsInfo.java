// UrlRequestDevToolsInfo.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class UrlRequestDevToolsInfo extends org.chromium.mojo.bindings.Struct {
    ...
    public static UrlRequestDevToolsInfo deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static UrlRequestDevToolsInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        UrlRequestDevToolsInfo result;
        try {
