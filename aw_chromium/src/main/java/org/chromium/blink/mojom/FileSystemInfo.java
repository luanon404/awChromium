// FileSystemInfo.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class FileSystemInfo extends org.chromium.mojo.bindings.Struct {
    ...
    public static FileSystemInfo deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static FileSystemInfo deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static FileSystemInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new FileSystemInfo(elementsOrVersion);
                {
