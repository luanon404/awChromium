// AudioProcessingStats.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class AudioProcessingStats extends org.chromium.mojo.bindings.Struct {
    ...
    public static AudioProcessingStats deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static AudioProcessingStats decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        AudioProcessingStats result;
        try {
