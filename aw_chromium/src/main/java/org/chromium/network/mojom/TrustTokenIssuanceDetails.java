// TrustTokenIssuanceDetails.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class TrustTokenIssuanceDetails extends org.chromium.mojo.bindings.Struct {
    ...
    public static TrustTokenIssuanceDetails deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static TrustTokenIssuanceDetails decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        TrustTokenIssuanceDetails result;
        try {
