 ...
 * holds [UnownedUserDataHost] entries.
 *
 *
 * Marking something as a UnownedUserData has no other implications than that the class can be
 * referenced from a [UnownedUserDataHost] as a [java.lang.ref.WeakReference].
 *
 *
 ...
 * particular [UnownedUserDataHost] they are attached to is destroyed.
 *
...
interface UnownedUserData {
     ...
     */
    fun onDetachedFromHost(host: UnownedUserDataHost?) {}
     ...
     */
    fun informOnDetachmentFromHost(): Boolean {
        return true
    }
}