...
public final class AwRenderProcess extends AwSupportLibIsomorphic {
    ...
    public boolean terminate() {
        ...
        return AwRenderProcessJni.get().terminateChildProcess(mNativeRenderProcess, AwRenderProcess.this);
    }

    public boolean isProcessLockedToSiteForTesting() {
        if (mNativeRenderProcess == 0) return false;

        return AwRenderProcessJni.get().isProcessLockedToSiteForTesting(mNativeRenderProcess, AwRenderProcess.this);
    }
