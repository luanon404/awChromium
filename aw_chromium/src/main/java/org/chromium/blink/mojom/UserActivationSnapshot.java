...
public final class UserActivationSnapshot extends org.chromium.mojo.bindings.Struct {
    ...
    public static UserActivationSnapshot deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static UserActivationSnapshot deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static UserActivationSnapshot decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        UserActivationSnapshot result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new UserActivationSnapshot(elementsOrVersion);
                {
