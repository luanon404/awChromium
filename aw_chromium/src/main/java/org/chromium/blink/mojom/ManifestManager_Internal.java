...
ParseManifestFromString_Response callback) {
            ...
            ManifestManagerParseManifestFromStringParams _message = new ManifestManagerParseManifestFromStringParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(
                                    PARSE_MANIFEST_FROM_STRING_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case PARSE_MANIFEST_FROM_STRING_ORDINAL: {

                        ManifestManagerParseManifestFromStringParams data =
                                ManifestManagerParseManifestFromStringParams.deserialize(messageWithHeader.getPayload());

                        getImpl().parseManifestFromString(data.documentUrl, data.manifestUrl, data.manifestContent, new ManifestManagerParseManifestFromStringResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class ManifestManagerParseManifestFromStringParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ManifestManagerParseManifestFromStringParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ManifestManagerParseManifestFromStringParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ManifestManagerParseManifestFromStringParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ManifestManagerParseManifestFromStringParams(elementsOrVersion);
                    {
    ...
    static final class ManifestManagerParseManifestFromStringResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ManifestManagerParseManifestFromStringResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ManifestManagerParseManifestFromStringResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ManifestManagerParseManifestFromStringResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ManifestManagerParseManifestFromStringResponseParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.parsedManifest, 8, true);
        }
    }

    static class ManifestManagerParseManifestFromStringResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final ManifestManager.ParseManifestFromString_Response mCallback;

        ManifestManagerParseManifestFromStringResponseParamsForwardToCallback(ManifestManager.ParseManifestFromString_Response callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(PARSE_MANIFEST_FROM_STRING_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }

                ManifestManagerParseManifestFromStringResponseParams response = ManifestManagerParseManifestFromStringResponseParams.deserialize(messageWithHeader.getPayload());

                mCallback.call(response.parsedManifest);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class ManifestManagerParseManifestFromStringResponseParamsProxyToResponder implements ManifestManager.ParseManifestFromString_Response {
        ...
        public void call(Manifest_ parsedManifest) {
            ManifestManagerParseManifestFromStringResponseParams _response = new ManifestManagerParseManifestFromStringResponseParams();
