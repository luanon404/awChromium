...
class PermissionService_Internal {
    ...
    private static final int REQUEST_PAGE_EMBEDDED_PERMISSION_ORDINAL = 1;

    private static final int REQUEST_PERMISSION_ORDINAL = 2;

    private static final int REQUEST_PERMISSIONS_ORDINAL = 3;

    private static final int REVOKE_PERMISSION_ORDINAL = 4;

    private static final int ADD_PERMISSION_OBSERVER_ORDINAL = 5;

    private static final int NOTIFY_EVENT_LISTENER_ORDINAL = 6;
...
RequestPageEmbeddedPermission_Response callback) {
            ...
            PermissionServiceRequestPageEmbeddedPermissionParams _message = new PermissionServiceRequestPageEmbeddedPermissionParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(
                                    REQUEST_PAGE_EMBEDDED_PERMISSION_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
                    new PermissionServiceRequestPageEmbeddedPermissionResponseParamsForwardToCallback(callback));
...
PermissionDescriptor permission, String eventType, boolean isAdded) {
            ...
            PermissionServiceNotifyEventListenerParams _message = new PermissionServiceNotifyEventListenerParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(NOTIFY_EVENT_LISTENER_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case NOTIFY_EVENT_LISTENER_ORDINAL: {

                        PermissionServiceNotifyEventListenerParams data =
                                PermissionServiceNotifyEventListenerParams.deserialize(messageWithHeader.getPayload());

                        getImpl().notifyEventListener(data.permission, data.eventType, data.isAdded);
                        return true;
                    }
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case REQUEST_PAGE_EMBEDDED_PERMISSION_ORDINAL: {

                        PermissionServiceRequestPageEmbeddedPermissionParams data =
                                PermissionServiceRequestPageEmbeddedPermissionParams.deserialize(messageWithHeader.getPayload());

                        getImpl().requestPageEmbeddedPermission(data.descriptor, new PermissionServiceRequestPageEmbeddedPermissionResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class PermissionServiceRequestPageEmbeddedPermissionParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PermissionServiceRequestPageEmbeddedPermissionParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PermissionServiceRequestPageEmbeddedPermissionParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PermissionServiceRequestPageEmbeddedPermissionParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PermissionServiceRequestPageEmbeddedPermissionParams(elementsOrVersion);
                    {
    ...
    static final class PermissionServiceRequestPageEmbeddedPermissionResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PermissionServiceRequestPageEmbeddedPermissionResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PermissionServiceRequestPageEmbeddedPermissionResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PermissionServiceRequestPageEmbeddedPermissionResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PermissionServiceRequestPageEmbeddedPermissionResponseParams(elementsOrVersion);
                    {
                        
                    result.status = decoder0.readInt(8);
                        EmbeddedPermissionControlResult.validate(result.status);
    ...
    static class PermissionServiceRequestPageEmbeddedPermissionResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final PermissionService.RequestPageEmbeddedPermission_Response mCallback;

        PermissionServiceRequestPageEmbeddedPermissionResponseParamsForwardToCallback(PermissionService.RequestPageEmbeddedPermission_Response callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(REQUEST_PAGE_EMBEDDED_PERMISSION_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }

                PermissionServiceRequestPageEmbeddedPermissionResponseParams response = PermissionServiceRequestPageEmbeddedPermissionResponseParams.deserialize(messageWithHeader.getPayload());
    ...
    static class PermissionServiceRequestPageEmbeddedPermissionResponseParamsProxyToResponder implements PermissionService.RequestPageEmbeddedPermission_Response {
        ...
        @Override
        public void call(Integer status) {
            PermissionServiceRequestPageEmbeddedPermissionResponseParams _response = new PermissionServiceRequestPageEmbeddedPermissionResponseParams();
    ...
    static final class PermissionServiceNotifyEventListenerParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PermissionServiceNotifyEventListenerParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PermissionServiceNotifyEventListenerParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PermissionServiceNotifyEventListenerParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PermissionServiceNotifyEventListenerParams(elementsOrVersion);
                    {
