...
class AndroidOverlayProvider_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<AndroidOverlayProvider, AndroidOverlayProvider.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<AndroidOverlayProvider, AndroidOverlayProvider.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements AndroidOverlayProvider.Proxy {
        ...
        @Override
        public void createOverlay(org.chromium.mojo.bindings.InterfaceRequest<AndroidOverlay> overlay, AndroidOverlayClient client, AndroidOverlayConfig config) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(CREATE_OVERLAY_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(AndroidOverlayProvider_Internal.MANAGER, messageWithHeader);


                    case CREATE_OVERLAY_ORDINAL: {

                        AndroidOverlayProviderCreateOverlayParams data = AndroidOverlayProviderCreateOverlayParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), AndroidOverlayProvider_Internal.MANAGER, messageWithHeader, receiver);
