// SkColorSpacePrimaries.java is auto generated by mojom_bindings_generator.py, do not edit
...
// For:
//     skia/public/mojom/skcolorspace_primaries.mojom
//
...
public final class SkColorSpacePrimaries extends org.chromium.mojo.bindings.Struct {
    ...
    public static SkColorSpacePrimaries deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static SkColorSpacePrimaries decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        SkColorSpacePrimaries result;
        try {
