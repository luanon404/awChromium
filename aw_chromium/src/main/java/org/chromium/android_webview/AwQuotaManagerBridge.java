...
public class AwQuotaManagerBridge {
    ...
    private int mNextId;
    private final SparseArray<Callback<Origins>> mPendingGetOriginCallbacks;
    private final SparseArray<Callback<Long>> mPendingGetQuotaForOriginCallbacks;
    private final SparseArray<Callback<Long>> mPendingGetUsageForOriginCallbacks;
