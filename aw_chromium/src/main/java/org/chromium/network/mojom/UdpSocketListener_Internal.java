...
class UdpSocketListener_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<UdpSocketListener, UdpSocketListener.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<UdpSocketListener, UdpSocketListener.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements UdpSocketListener.Proxy {
        ...
        @Override
        public void onReceived(int result, IpEndPoint srcAddr, org.chromium.mojo_base.mojom.ReadOnlyBuffer data) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_RECEIVED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(UdpSocketListener_Internal.MANAGER, messageWithHeader);
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), UdpSocketListener_Internal.MANAGER, messageWithHeader, receiver);
