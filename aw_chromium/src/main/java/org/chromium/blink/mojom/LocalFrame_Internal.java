...
class LocalFrame_Internal {
    ...
    private static final int SNAPSHOT_DOCUMENT_FOR_VIEW_TRANSITION_ORDINAL = 42;

    private static final int ADD_RESOURCE_TIMING_ENTRY_FOR_FAILED_SUBFRAME_NAVIGATION_ORDINAL = 43;

    private static final int REQUEST_FULLSCREEN_DOCUMENT_ELEMENT_ORDINAL = 44;
...
NavigationApiHistoryEntryArrays entryArrays) {
        ...
        @Override
        public void notifyNavigationApiOfDisposedEntries(
String[] keys) {

            LocalFrameNotifyNavigationApiOfDisposedEntriesParams _message = new LocalFrameNotifyNavigationApiOfDisposedEntriesParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(NOTIFY_NAVIGATION_API_OF_DISPOSED_ENTRIES_ORDINAL)));

        }


        @Override
        public void traverseCancelled(
String navigationApiKey, int reason) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(TRAVERSE_CANCELLED_ORDINAL)));
...
SnapshotDocumentForViewTransition_Response callback) {
            ...
            LocalFrameSnapshotDocumentForViewTransitionParams _message = new LocalFrameSnapshotDocumentForViewTransitionParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(
                                    SNAPSHOT_DOCUMENT_FOR_VIEW_TRANSITION_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
                    new LocalFrameSnapshotDocumentForViewTransitionResponseParamsForwardToCallback(callback));
...
FrameToken subframeToken, org.chromium.url.mojom.Url initialUrl, org.chromium.mojo_base.mojom.TimeTicks startTime, org.chromium.mojo_base.mojom.TimeTicks redirectTime, org.chromium.mojo_base.mojom.TimeTicks requestStart, org.chromium.mojo_base.mojom.TimeTicks responseStart, int responseCode, String mimeType, org.chromium.network.mojom.LoadTimingInfo loadTimingInfo, int connectionInfo, String alpnNegotiatedProtocol, boolean isSecureTransport, boolean isValidated, String normalizedServerTiming, org.chromium.network.mojom.UrlLoaderCompletionStatus completionStatus) {
            ...
            LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams _message = new LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(ADD_RESOURCE_TIMING_ENTRY_FOR_FAILED_SUBFRAME_NAVIGATION_ORDINAL)));
        ...
        public void requestFullscreenDocumentElement(
            ...
            LocalFrameRequestFullscreenDocumentElementParams _message = new LocalFrameRequestFullscreenDocumentElementParams();


            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(REQUEST_FULLSCREEN_DOCUMENT_ELEMENT_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case NOTIFY_NAVIGATION_API_OF_DISPOSED_ENTRIES_ORDINAL: {

                        LocalFrameNotifyNavigationApiOfDisposedEntriesParams data =
                                LocalFrameNotifyNavigationApiOfDisposedEntriesParams.deserialize(messageWithHeader.getPayload());

                        getImpl().notifyNavigationApiOfDisposedEntries(data.keys);
                        return true;
                    }
                    ...
                    case TRAVERSE_CANCELLED_ORDINAL: {

                        LocalFrameTraverseCancelledParams data =
                                LocalFrameTraverseCancelledParams.deserialize(messageWithHeader.getPayload());

                        getImpl().traverseCancelled(data.navigationApiKey, data.reason);
                        return true;
                    }
                    ...
                    case ADD_RESOURCE_TIMING_ENTRY_FOR_FAILED_SUBFRAME_NAVIGATION_ORDINAL: {

                        LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams data =
                                LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams.deserialize(messageWithHeader.getPayload());

                        getImpl().addResourceTimingEntryForFailedSubframeNavigation(data.subframeToken, data.initialUrl, data.startTime, data.redirectTime, data.requestStart, data.responseStart, data.responseCode, data.mimeType, data.loadTimingInfo, data.connectionInfo, data.alpnNegotiatedProtocol, data.isSecureTransport, data.isValidated, data.normalizedServerTiming, data.completionStatus);
                        return true;
                    }
                    ...
                    case REQUEST_FULLSCREEN_DOCUMENT_ELEMENT_ORDINAL: {

                        LocalFrameRequestFullscreenDocumentElementParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case SNAPSHOT_DOCUMENT_FOR_VIEW_TRANSITION_ORDINAL: {

                        LocalFrameSnapshotDocumentForViewTransitionParams.deserialize(messageWithHeader.getPayload());

                        getImpl().snapshotDocumentForViewTransition(new LocalFrameSnapshotDocumentForViewTransitionResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class LocalFrameNotifyNavigationApiOfDisposedEntriesParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static LocalFrameNotifyNavigationApiOfDisposedEntriesParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameNotifyNavigationApiOfDisposedEntriesParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameNotifyNavigationApiOfDisposedEntriesParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameNotifyNavigationApiOfDisposedEntriesParams(elementsOrVersion);
                    {
    ...
    static final class LocalFrameTraverseCancelledParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static LocalFrameTraverseCancelledParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameTraverseCancelledParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameTraverseCancelledParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameTraverseCancelledParams(elementsOrVersion);
                    {
                    ...
                    result.reason = decoder0.readInt(16);
                        TraverseCancelledReason.validate(result.reason);
    ...
    static final class LocalFrameSnapshotDocumentForViewTransitionParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static LocalFrameSnapshotDocumentForViewTransitionParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameSnapshotDocumentForViewTransitionParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameSnapshotDocumentForViewTransitionParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameSnapshotDocumentForViewTransitionParams(elementsOrVersion);
    ...
    static final class LocalFrameSnapshotDocumentForViewTransitionResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static LocalFrameSnapshotDocumentForViewTransitionResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameSnapshotDocumentForViewTransitionResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameSnapshotDocumentForViewTransitionResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameSnapshotDocumentForViewTransitionResponseParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.viewTransitionState, 8, false);
        }
    }

    static class LocalFrameSnapshotDocumentForViewTransitionResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final LocalFrame.SnapshotDocumentForViewTransition_Response mCallback;

        LocalFrameSnapshotDocumentForViewTransitionResponseParamsForwardToCallback(LocalFrame.SnapshotDocumentForViewTransition_Response callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(SNAPSHOT_DOCUMENT_FOR_VIEW_TRANSITION_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }

                LocalFrameSnapshotDocumentForViewTransitionResponseParams response = LocalFrameSnapshotDocumentForViewTransitionResponseParams.deserialize(messageWithHeader.getPayload());

                mCallback.call(response.viewTransitionState);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class LocalFrameSnapshotDocumentForViewTransitionResponseParamsProxyToResponder implements LocalFrame.SnapshotDocumentForViewTransition_Response {
        ...
        public void call(ViewTransitionState viewTransitionState) {
            LocalFrameSnapshotDocumentForViewTransitionResponseParams _response = new LocalFrameSnapshotDocumentForViewTransitionResponseParams();
    ...
    static final class LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams extends org.chromium.mojo.bindings.Struct {
        ...
        public org.chromium.url.mojom.Url initialUrl;
        public org.chromium.mojo_base.mojom.TimeTicks startTime;
        public org.chromium.mojo_base.mojom.TimeTicks redirectTime;
        ...
        public org.chromium.network.mojom.UrlLoaderCompletionStatus completionStatus;
        ...
        public static LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameAddResourceTimingEntryForFailedSubframeNavigationParams(elementsOrVersion);
                    {
                    ...
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(24, false);
                    result.initialUrl = org.chromium.url.mojom.Url.decode(decoder1);
                    }
                    {
                    ...
                    result.redirectTime = org.chromium.mojo_base.mojom.TimeTicks.decode(decoder1);
                    }
                    {
                    ...
                    result.connectionInfo = decoder0.readInt(68);
                    ...
                    result.completionStatus = org.chromium.network.mojom.UrlLoaderCompletionStatus.decode(decoder1);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.subframeToken, 8, false);
            
            encoder0.encode(this.initialUrl, 24, false);
            
            encoder0.encode(this.startTime, 32, false);
            
            encoder0.encode(this.redirectTime, 40, false);
            
            encoder0.encode(this.requestStart, 48, false);
            
            encoder0.encode(this.responseStart, 56, false);
            ...
            encoder0.encode(this.completionStatus, 112, false);
        }
    }
    ...
    static final class LocalFrameRequestFullscreenDocumentElementParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static LocalFrameRequestFullscreenDocumentElementParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameRequestFullscreenDocumentElementParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameRequestFullscreenDocumentElementParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameRequestFullscreenDocumentElementParams(elementsOrVersion);
