...
class DateTimeChooserAndroid {
    ...
    private DateTimeChooserAndroid(Context context, long nativeDateTimeChooserAndroid) {
        ...
        mInputDialogContainer = new InputDialogContainer(context, new InputDialogContainer.InputActionDelegate() {
            ...
            public void replaceDateTime(double value) {
                ...
                DateTimeChooserAndroidJni.get().replaceDateTime(mNativeDateTimeChooserAndroid, DateTimeChooserAndroid.this, value);
            }
            ...
            public void cancelDateTimeDialog() {
                ...
                DateTimeChooserAndroidJni.get().cancelDialog(mNativeDateTimeChooserAndroid, DateTimeChooserAndroid.this);
            }
        });
    }
    ...
    private static DateTimeChooserAndroid createDateTimeChooser(WindowAndroid windowAndroid, long nativeDateTimeChooserAndroid, int dialogType, double dialogValue, double min, double max, double step, DateTimeSuggestion[] suggestions) {
        ...
        if (windowAndroidContext == null || ContextUtils.activityFromContext(windowAndroidContext) == null) {
            return null;
        }
        DateTimeChooserAndroid chooser = new DateTimeChooserAndroid(windowAndroidContext, nativeDateTimeChooserAndroid);
    ...
    @NativeMethods
    interface Natives {
        void replaceDateTime(long nativeDateTimeChooserAndroid, DateTimeChooserAndroid caller, double dialogValue);
