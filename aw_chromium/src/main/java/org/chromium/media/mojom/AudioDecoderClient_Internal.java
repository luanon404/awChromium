// AudioDecoderClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class AudioDecoderClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<AudioDecoderClient, AudioDecoderClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<AudioDecoderClient, AudioDecoderClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements AudioDecoderClient.Proxy {
        ...
        public void onBufferDecoded(AudioBuffer buffer) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_BUFFER_DECODED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(AudioDecoderClient_Internal.MANAGER, messageWithHeader);
                    ...
                    case ON_WAITING_ORDINAL: {
                        ...
                        AudioDecoderClientOnWaitingParams data = AudioDecoderClientOnWaitingParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), AudioDecoderClient_Internal.MANAGER, messageWithHeader, receiver);
    ...
    static final class AudioDecoderClientOnWaitingParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static AudioDecoderClientOnWaitingParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static AudioDecoderClientOnWaitingParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
