// InputDeviceManagerClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class InputDeviceManagerClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<InputDeviceManagerClient, InputDeviceManagerClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<InputDeviceManagerClient, InputDeviceManagerClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements InputDeviceManagerClient.Proxy {
        ...
        public void inputDeviceAdded(InputDeviceInfo deviceInfo) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(INPUT_DEVICE_ADDED_ORDINAL)));
        ...
        public void inputDeviceRemoved(String id) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(INPUT_DEVICE_REMOVED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(InputDeviceManagerClient_Internal.MANAGER, messageWithHeader);
                    ...
                    case INPUT_DEVICE_REMOVED_ORDINAL: {
                        ...
                        InputDeviceManagerClientInputDeviceRemovedParams data = InputDeviceManagerClientInputDeviceRemovedParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), InputDeviceManagerClient_Internal.MANAGER, messageWithHeader, receiver);
