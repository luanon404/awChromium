// SmartCardResult.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class SmartCardResult extends org.chromium.mojo.bindings.Union {
    ...
    public static SmartCardResult deserialize(org.chromium.mojo.bindings.Message message) {
        return decode(new org.chromium.mojo.bindings.Decoder(message).decoderForSerializedUnion(), 0);
    }

    public static final SmartCardResult decode(org.chromium.mojo.bindings.Decoder decoder0, int offset) {
        ...
        switch (dataHeader.elementsOrVersion) {
            case Tag.Success: {
                ...
                result.mSuccess = decoder0.readInt(offset + org.chromium.mojo.bindings.DataHeader.HEADER_SIZE);
                    SmartCardSuccess.validate(result.mSuccess);
