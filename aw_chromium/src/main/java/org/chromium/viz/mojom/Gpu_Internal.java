...
class Gpu_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<Gpu, Gpu.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<Gpu, Gpu.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements Gpu.Proxy {
        ...
        @Override
        public void createGpuMemoryBufferFactory(org.chromium.mojo.bindings.InterfaceRequest<GpuMemoryBufferFactory> receiver) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(CREATE_GPU_MEMORY_BUFFER_FACTORY_ORDINAL)));

        }


        @Override
        public void createClientGpuMemoryBufferFactory(org.chromium.mojo.bindings.InterfaceRequest<org.chromium.gpu.mojom.ClientGmbInterface> receiver) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(CREATE_CLIENT_GPU_MEMORY_BUFFER_FACTORY_ORDINAL)));
        ...
        public void establishGpuChannel(
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ESTABLISH_GPU_CHANNEL_ORDINAL, org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG, 0)), new GpuEstablishGpuChannelResponseParamsForwardToCallback(callback));

        }


        @Override
        public void createVideoEncodeAcceleratorProvider(org.chromium.mojo.bindings.InterfaceRequest<org.chromium.media.mojom.VideoEncodeAcceleratorProvider> veaProvider) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(CREATE_VIDEO_ENCODE_ACCELERATOR_PROVIDER_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(Gpu_Internal.MANAGER, messageWithHeader);
                    ...
                    case CREATE_CLIENT_GPU_MEMORY_BUFFER_FACTORY_ORDINAL: {
                        ...
                        GpuCreateClientGpuMemoryBufferFactoryParams data = GpuCreateClientGpuMemoryBufferFactoryParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case CREATE_VIDEO_ENCODE_ACCELERATOR_PROVIDER_ORDINAL: {
                        ...
                        GpuCreateVideoEncodeAcceleratorProviderParams data = GpuCreateVideoEncodeAcceleratorProviderParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), Gpu_Internal.MANAGER, messageWithHeader, receiver);
    ...
    static class GpuEstablishGpuChannelResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable implements org.chromium.mojo.bindings.MessageReceiver {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader = message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(ESTABLISH_GPU_CHANNEL_ORDINAL, org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }
    ...
    static class GpuEstablishGpuChannelResponseParamsProxyToResponder implements Gpu.EstablishGpuChannel_Response {
        ...
        GpuEstablishGpuChannelResponseParamsProxyToResponder(org.chromium.mojo.system.Core core, org.chromium.mojo.bindings.MessageReceiver messageReceiver, long requestId) {
            mCore = core;
        ...
        public void call(Integer clientId, org.chromium.mojo.system.MessagePipeHandle channelHandle, org.chromium.gpu.mojom.GpuInfo gpuInfo, org.chromium.gpu.mojom.GpuFeatureInfo gpuFeatureInfo, org.chromium.gpu.mojom.SharedImageCapabilities sharedImageCapabilities) {
            ...
            org.chromium.mojo.bindings.ServiceMessage _message = _response.serializeWithHeader(mCore, new org.chromium.mojo.bindings.MessageHeader(ESTABLISH_GPU_CHANNEL_ORDINAL, org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG, mRequestId));
