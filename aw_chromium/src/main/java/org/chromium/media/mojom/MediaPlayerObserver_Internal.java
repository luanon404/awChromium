...
class MediaPlayerObserver_Internal {
    ...
    static final class MediaPlayerObserverOnUseAudioServiceChangedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static MediaPlayerObserverOnUseAudioServiceChangedParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static MediaPlayerObserverOnUseAudioServiceChangedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
    ...
    static final class MediaPlayerObserverOnRemotePlaybackMetadataChangeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static MediaPlayerObserverOnRemotePlaybackMetadataChangeParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static MediaPlayerObserverOnRemotePlaybackMetadataChangeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
