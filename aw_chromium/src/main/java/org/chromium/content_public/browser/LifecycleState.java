...
@IntDef({LifecycleState.PENDING_COMMIT, LifecycleState.ACTIVE, LifecycleState.PRERENDERING, LifecycleState.IN_BACK_FORWARD_CACHE, LifecycleState.PENDING_DELETION})
