...
class AwSettingsJni implements AwSettings.Natives {
    ...
    public static final JniStaticTestMocker<AwSettings.Natives> TEST_HOOKS = new JniStaticTestMocker<AwSettings.Natives>() {
        @Override
    ...
    public static AwSettings.Natives get() {
        if (GEN_JNI.TESTING_ENABLED) {
            ...
            if (GEN_JNI.REQUIRE_MOCK) {
                throw new UnsupportedOperationException("No mock found for the native implementation of AwSettings.Natives. " + "The current configuration requires implementations be mocked.");
            }
        }
