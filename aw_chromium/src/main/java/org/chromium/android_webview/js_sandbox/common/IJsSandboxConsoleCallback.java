...
public interface IJsSandboxConsoleCallback extends android.os.IInterface {
     ...
     */
    class Default implements org.chromium.android_webview.js_sandbox.common.IJsSandboxConsoleCallback {
        /**
     ...
     */
    abstract class Stub extends android.os.Binder implements org.chromium.android_webview.js_sandbox.common.IJsSandboxConsoleCallback {
        /**
    ...
    java.lang.String DESCRIPTOR = "org.chromium.android_webview.js_sandbox.common.IJsSandboxConsoleCallback";
    // These must be individual bits so that they can be trivially filtered using a bitmask.
    int CONSOLE_MESSAGE_LEVEL_LOG = 1;
    int CONSOLE_MESSAGE_LEVEL_DEBUG = 2;
    int CONSOLE_MESSAGE_LEVEL_INFO = 4;
    int CONSOLE_MESSAGE_LEVEL_ERROR = 8;
    int CONSOLE_MESSAGE_LEVEL_WARNING = 16;
     ...
     * @param trace          Stack trace of where the message was generated, which may be null.
     */
    void consoleMessage(int contextGroupId, int level, java.lang.String message, java.lang.String source, int line, int column, java.lang.String trace) throws android.os.RemoteException;
     ...
     * @param contextGroupId context group ID.
     */
    void consoleClear(int contextGroupId) throws android.os.RemoteException;
}
