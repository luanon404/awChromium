// WalletProvider.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class WalletProvider extends org.chromium.mojo.bindings.Struct {

    private static final int STRUCT_SIZE = 24;
    private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(24, 0)};
    private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
    public java.util.Map<String, String> params;
    public WalletSelector selector;

    private WalletProvider(int version) {
    ...
    public static WalletProvider deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static WalletProvider deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static WalletProvider decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new WalletProvider(elementsOrVersion);
                {
                ...
                result.selector = WalletSelector.decode(decoder1);
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.selector, 16, false);
    }
}