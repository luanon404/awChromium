// V8DetailedMemoryReporter_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class V8DetailedMemoryReporter_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<V8DetailedMemoryReporter, V8DetailedMemoryReporter.Proxy> MANAGER =
            new org.chromium.mojo.bindings.Interface.Manager<V8DetailedMemoryReporter, V8DetailedMemoryReporter.Proxy>() {
        ...
        @Override
        public Stub buildStub(org.chromium.mojo.system.Core core, V8DetailedMemoryReporter impl) {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements V8DetailedMemoryReporter.Proxy {
...
GetV8MemoryUsage_Response callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            ...
                            new org.chromium.mojo.bindings.MessageHeader(
                                    GET_V8_MEMORY_USAGE_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
                    new V8DetailedMemoryReporterGetV8MemoryUsageResponseParamsForwardToCallback(callback));
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<V8DetailedMemoryReporter> {

        Stub(org.chromium.mojo.system.Core core, V8DetailedMemoryReporter impl) {
            super(core, impl);
        }
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_V8_MEMORY_USAGE_ORDINAL: {

                        V8DetailedMemoryReporterGetV8MemoryUsageParams data =
                                V8DetailedMemoryReporterGetV8MemoryUsageParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class V8DetailedMemoryReporterGetV8MemoryUsageParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static V8DetailedMemoryReporterGetV8MemoryUsageParams deserialize(org.chromium.mojo.bindings.Message message) {
         ...
         */
        public static V8DetailedMemoryReporterGetV8MemoryUsageParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static V8DetailedMemoryReporterGetV8MemoryUsageParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                result = new V8DetailedMemoryReporterGetV8MemoryUsageParams(elementsOrVersion);
                    {
    ...
    static final class V8DetailedMemoryReporterGetV8MemoryUsageResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static V8DetailedMemoryReporterGetV8MemoryUsageResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static V8DetailedMemoryReporterGetV8MemoryUsageResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static V8DetailedMemoryReporterGetV8MemoryUsageResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new V8DetailedMemoryReporterGetV8MemoryUsageResponseParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.memoryUsage, 8, false);
        }
    }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(GET_V8_MEMORY_USAGE_ORDINAL,
                ...
                mCallback.call(response.memoryUsage);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
