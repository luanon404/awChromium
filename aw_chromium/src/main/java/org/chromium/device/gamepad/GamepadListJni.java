...
class GamepadListJni implements GamepadList.Natives {
    ...
    public static final JniStaticTestMocker<GamepadList.Natives> TEST_HOOKS = new JniStaticTestMocker<GamepadList.Natives>() {
        @Override
    ...
    public static GamepadList.Natives get() {
        if (GEN_JNI.TESTING_ENABLED) {
            ...
            if (GEN_JNI.REQUIRE_MOCK) {
                throw new UnsupportedOperationException("No mock found for the native implementation of GamepadList.Natives. " + "The current configuration requires implementations be mocked.");
            }
        }
