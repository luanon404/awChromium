...
public class ChromeBulletSpan extends BulletSpan {
    ...
    public ChromeBulletSpan(Context context) {
        ...
        mXOffset = context.getResources().getDimensionPixelSize(R.dimen.chrome_bullet_leading_offset);
    }
    ...
    public void drawLeadingMargin(Canvas c, Paint p, int x, int dir, int top, int baseline, int bottom, CharSequence text, int start, int end, boolean first, Layout l) {
        ...
        // cut off.
        super.drawLeadingMargin(c, p, x + mXOffset, dir, top, baseline, bottom, text, start, end, first, l);
    }
}
