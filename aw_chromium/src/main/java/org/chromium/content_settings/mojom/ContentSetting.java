...
public final class ContentSetting {
    ...
    @IntDef({ContentSetting.DEFAULT, ContentSetting.ALLOW, ContentSetting.BLOCK, ContentSetting.ASK, ContentSetting.SESSION_ONLY, ContentSetting.DETECT_IMPORTANT_CONTENT})
