...
public class Origin {
    ...
    public String getScheme() {
        return !isOpaque() ? Objects.requireNonNull(mInternal).getScheme() : "";
    }
    ...
    public String getHost() {
        return !isOpaque() ? Objects.requireNonNull(mInternal).getHost() : "";
    }
     ...
     */
    public int getPort() {
        return !isOpaque() ? Objects.requireNonNull(mInternal).getPort() : 0;
    }
    ...
    public boolean isOpaque() {
        return Objects.requireNonNull(mInternal).getNonceIfOpaque() != null;
    }
