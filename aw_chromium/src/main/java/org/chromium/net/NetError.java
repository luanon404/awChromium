...
public @interface NetError {
    ...
    int ERR_INVALID_ECH_CONFIG_LIST = -182;
    int ERR_ECH_NOT_NEGOTIATED = -183;
    int ERR_ECH_FALLBACK_CERTIFICATE_INVALID = -184;
    ...
    int ERR_TOO_MANY_ACCEPT_CH_RESTARTS = -382;
    int ERR_INCONSISTENT_IP_ADDRESS_SPACE = -383;
    int ERR_CACHED_IP_ADDRESS_SPACE_BLOCKED_BY_PRIVATE_NETWORK_ACCESS_POLICY = -384;
    ...
    int ERR_CERT_VERIFIER_CHANGED = -716;
    ...
    int ERR_DNS_NAME_HTTPS_ONLY = -809;
    int ERR_DNS_REQUEST_CANCELLED = -810;
    int ERR_DNS_NO_MATCHING_SUPPORTED_ALPN = -811;
    int ERR_DICTIONARY_LOAD_FAILED = -812;
}
