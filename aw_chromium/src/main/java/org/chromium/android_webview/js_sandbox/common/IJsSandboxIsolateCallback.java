...
public interface IJsSandboxIsolateCallback extends android.os.IInterface {
     ...
     */
    class Default implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateCallback {
        @Override
     ...
     */
    abstract class Stub extends android.os.Binder implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateCallback {
        /**
    ...
    java.lang.String DESCRIPTOR = "org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateCallback";
    ...
    void reportResult(java.lang.String result) throws android.os.RemoteException;

    // errorType is one of the error constants above.
    void reportError(int errorType, java.lang.String error) throws android.os.RemoteException;
}
