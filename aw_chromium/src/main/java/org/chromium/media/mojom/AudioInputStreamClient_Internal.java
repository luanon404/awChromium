// AudioInputStreamClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class AudioInputStreamClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<AudioInputStreamClient, AudioInputStreamClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<AudioInputStreamClient, AudioInputStreamClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements AudioInputStreamClient.Proxy {
        ...
        public void onMutedStateChanged(boolean isMuted) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_MUTED_STATE_CHANGED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(AudioInputStreamClient_Internal.MANAGER, messageWithHeader);


                    case ON_ERROR_ORDINAL: {

                        AudioInputStreamClientOnErrorParams data = AudioInputStreamClientOnErrorParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_MUTED_STATE_CHANGED_ORDINAL: {
                        ...
                        AudioInputStreamClientOnMutedStateChangedParams data = AudioInputStreamClientOnMutedStateChangedParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), AudioInputStreamClient_Internal.MANAGER, messageWithHeader, receiver);
