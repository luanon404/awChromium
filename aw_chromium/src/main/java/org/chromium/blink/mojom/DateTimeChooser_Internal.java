// DateTimeChooser_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class DateTimeChooser_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<DateTimeChooser, DateTimeChooser.Proxy> MANAGER =
            new org.chromium.mojo.bindings.Interface.Manager<DateTimeChooser, DateTimeChooser.Proxy>() {
        ...
        @Override
        public Stub buildStub(org.chromium.mojo.system.Core core, DateTimeChooser impl) {
...
OpenDateTimeDialog_Response callback) {
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<DateTimeChooser> {

        Stub(org.chromium.mojo.system.Core core, DateTimeChooser impl) {
            super(core, impl);
        }
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case OPEN_DATE_TIME_DIALOG_ORDINAL: {
    ...
    static final class DateTimeChooserOpenDateTimeDialogParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static DateTimeChooserOpenDateTimeDialogParams deserialize(org.chromium.mojo.bindings.Message message) {
         ...
         */
        public static DateTimeChooserOpenDateTimeDialogParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static DateTimeChooserOpenDateTimeDialogParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
    ...
    static final class DateTimeChooserOpenDateTimeDialogResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static DateTimeChooserOpenDateTimeDialogResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static DateTimeChooserOpenDateTimeDialogResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static DateTimeChooserOpenDateTimeDialogResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(OPEN_DATE_TIME_DIALOG_ORDINAL,
                ...
                mCallback.call(response.success, response.dialogValue);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
