...
public final class FormData extends org.chromium.mojo.bindings.Struct {
    ...
    public static FormData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new FormData(elementsOrVersion);
                ...
                result.isActionEmpty = decoder0.readBoolean(48, 0);
                }
                {
                    
                result.isFormTag = decoder0.readBoolean(48, 1);
                }
                {
                    
                result.isGaiaWithSkipSavePasswordForm = decoder0.readBoolean(48, 2);
                }
                {
                    
                result.submissionEvent = decoder0.readInt(52);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.action, 40, false);
        
        encoder0.encode(this.isActionEmpty, 48, 0);
        
        encoder0.encode(this.isFormTag, 48, 1);
        
        encoder0.encode(this.isGaiaWithSkipSavePasswordForm, 48, 2);
        
        encoder0.encode(this.submissionEvent, 52);
        
        encoder0.encode(this.uniqueRendererId, 56, false);
        
        if (this.childFrames == null) {
            encoder0.encodeNullPointer(64, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.childFrames.length, 64, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        if (this.fields == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.fields.length, 72, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        if (this.usernamePredictions == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.usernamePredictions.length, 80, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
