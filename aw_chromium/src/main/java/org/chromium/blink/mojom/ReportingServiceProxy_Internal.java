            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case QUEUE_PERMISSIONS_POLICY_VIOLATION_REPORT_ORDINAL: {
                        ...
                        getImpl().queuePermissionsPolicyViolationReport(data.url, data.endpoint, data.policyId, data.disposition, data.message, data.sourceFile, data.lineNumber, data.columnNumber);
                        return true;
                    }
