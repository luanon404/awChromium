...
public class AdditionalNavigationParamsUtils {
    ...
    @CalledByNative
    private static AdditionalNavigationParams create(UnguessableToken initiatorFrameToken, int initiatorProcessId, @Nullable UnguessableToken attributionSrcToken, long attributionRuntimeFeatures) {
        return new AdditionalNavigationParams(initiatorFrameToken, initiatorProcessId, attributionSrcToken, attributionRuntimeFeatures);
    }
