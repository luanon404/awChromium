...
class NfcClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<NfcClient, NfcClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<NfcClient, NfcClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements NfcClient.Proxy {
        ...
        public void onWatch(int[] watchIds, String serialNumber, NdefMessage message) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_WATCH_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(NfcClient_Internal.MANAGER, messageWithHeader);


                    case ON_WATCH_ORDINAL: {

                        NfcClientOnWatchParams data = NfcClientOnWatchParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_ERROR_ORDINAL: {
                        ...
                        NfcClientOnErrorParams data = NfcClientOnErrorParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), NfcClient_Internal.MANAGER, messageWithHeader, receiver);
