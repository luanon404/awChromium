...
public final class RendererPreferences extends org.chromium.mojo.bindings.Struct {
    ...
    private RendererPreferences(int version) {
        ...
        this.activeSelectionBgColor = (int) 4279855058L;
        this.activeSelectionFgColor = (int) 4278190080L;
        ...
        this.sendSubresourceNotification = (boolean) false;
    ...
    public static RendererPreferences decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new RendererPreferences(elementsOrVersion);
                ...
                result.sendSubresourceNotification = decoder0.readBoolean(9, 4);
                }
                {
                    
                result.pluginFullscreenAllowed = decoder0.readBoolean(9, 5);
                }
                {
                    
                result.caretBrowsingEnabled = decoder0.readBoolean(9, 6);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.sendSubresourceNotification, 9, 4);
        
        encoder0.encode(this.pluginFullscreenAllowed, 9, 5);
        
        encoder0.encode(this.caretBrowsingEnabled, 9, 6);
