// ServiceWorkerRouterConditionObject.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class ServiceWorkerRouterConditionObject extends org.chromium.mojo.bindings.Struct {
    ...
    private ServiceWorkerRouterConditionObject(int version) {
        super(STRUCT_SIZE, version);
    }

    public ServiceWorkerRouterConditionObject() {
        this(0);
    }

    public static ServiceWorkerRouterConditionObject deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static ServiceWorkerRouterConditionObject deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static ServiceWorkerRouterConditionObject decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        ServiceWorkerRouterConditionObject result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new ServiceWorkerRouterConditionObject(elementsOrVersion);
                {
