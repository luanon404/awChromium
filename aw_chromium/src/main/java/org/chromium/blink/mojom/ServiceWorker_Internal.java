...
org.chromium.mojo_base.mojom.TimeDelta delay) {
        ...
        public void addKeepAlive(
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(ADD_KEEP_ALIVE_ORDINAL)));
        ...
        public void clearKeepAlive(
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(CLEAR_KEEP_ALIVE_ORDINAL)));
...
ExecuteScriptForTest_Response callback) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case INITIALIZE_GLOBAL_SCOPE_ORDINAL: {
                        ...
                        getImpl().initializeGlobalScope(data.serviceWorkerHost, data.associatedInterfacesToBrowser, data.associatedInterfacesFromBrowser, data.registrationInfo, data.serviceWorkerInfo, data.fetchHandlerExistence, data.reportingObserverReceiver, data.ancestorFrameType, data.storageKey);
                        return true;
                    }
    ...
    static final class ServiceWorkerInitializeGlobalScopeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public org.chromium.mojo.bindings.AssociatedInterfaceNotSupported associatedInterfacesToBrowser;
        public org.chromium.mojo.bindings.AssociatedInterfaceRequestNotSupported associatedInterfacesFromBrowser;
        ...
        public static ServiceWorkerInitializeGlobalScopeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new ServiceWorkerInitializeGlobalScopeParams(elementsOrVersion);
                    ...
                    result.associatedInterfacesToBrowser = decoder0.readAssociatedServiceInterfaceNotSupported(16, false);
                    }
                    {
                        
                    result.associatedInterfacesFromBrowser = decoder0.readAssociatedInterfaceRequestNotSupported(24, false);
                    }
                    {
                        
                    result.fetchHandlerExistence = decoder0.readInt(28);
                    ...
                    result.ancestorFrameType = decoder0.readInt(52);
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.registrationInfo, 32, false);
            
            encoder0.encode(this.serviceWorkerInfo, 40, false);
            
            encoder0.encode(this.reportingObserverReceiver, 48, true);
            
            encoder0.encode(this.ancestorFrameType, 52);
            
            encoder0.encode(this.storageKey, 56, false);
        }
    }
    ...
    static final class ServiceWorkerAddKeepAliveParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ServiceWorkerAddKeepAliveParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ServiceWorkerAddKeepAliveParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ServiceWorkerAddKeepAliveParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ServiceWorkerAddKeepAliveParams(elementsOrVersion);
    ...
    static final class ServiceWorkerClearKeepAliveParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ServiceWorkerClearKeepAliveParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ServiceWorkerClearKeepAliveParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ServiceWorkerClearKeepAliveParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ServiceWorkerClearKeepAliveParams(elementsOrVersion);
