// PotentiallyOpaqueConfigVector.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class PotentiallyOpaqueConfigVector extends org.chromium.mojo.bindings.Union {
    ...
    public static PotentiallyOpaqueConfigVector deserialize(org.chromium.mojo.bindings.Message message) {
        return decode(new org.chromium.mojo.bindings.Decoder(message).decoderForSerializedUnion(), 0);
    }

    public static final PotentiallyOpaqueConfigVector decode(org.chromium.mojo.bindings.Decoder decoder0, int offset) {
