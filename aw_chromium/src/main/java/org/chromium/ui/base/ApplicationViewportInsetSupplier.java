...
public class ApplicationViewportInsetSupplier extends ObservableSupplierImpl<ViewportInsets> implements Destroyable {
    ...
    public void setVirtualKeyboardMode(@VirtualKeyboardMode.EnumType int mode) {
        ...
        @VirtualKeyboardMode.EnumType int oldMode = mVirtualKeyboardMode;
    ...
    private void computeInsets() {
        ...
        newValues.visualViewportBottomInset = mVirtualKeyboardMode == VirtualKeyboardMode.RESIZES_VISUAL ? totalKeyboardInset : 0;
        ...
        boolean vkModeOutsetsWebContentsHeight = mVirtualKeyboardMode == VirtualKeyboardMode.OVERLAYS_CONTENT || mVirtualKeyboardMode == VirtualKeyboardMode.RESIZES_VISUAL;
