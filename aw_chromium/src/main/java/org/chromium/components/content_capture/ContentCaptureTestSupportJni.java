...
class ContentCaptureTestSupportJni implements ContentCaptureTestSupport.Natives {
  ...
  public static final JniStaticTestMocker<ContentCaptureTestSupport.Natives> TEST_HOOKS =
      new JniStaticTestMocker<ContentCaptureTestSupport.Natives>() {
    @Override
    ...
    if (GEN_JNI.TESTING_ENABLED) {
      ...
      if (GEN_JNI.REQUIRE_MOCK) {
        throw new UnsupportedOperationException(
            "No mock found for the native implementation of ContentCaptureTestSupport.Natives. "
