// SpecMediaMetadata.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class SpecMediaMetadata extends org.chromium.mojo.bindings.Struct {
    ...
    public org.chromium.media_session.mojom.MediaImage[] artwork;
    ...
    public static SpecMediaMetadata deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static SpecMediaMetadata deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static SpecMediaMetadata decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        SpecMediaMetadata result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new SpecMediaMetadata(elementsOrVersion);
                {
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(32, false);
                {
                    ...
                    result.artwork = new org.chromium.media_session.mojom.MediaImage[si1.elementsOrVersion];
                    for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                        
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                        result.artwork[i1] = org.chromium.media_session.mojom.MediaImage.decode(decoder2);
                    }
                }
                }
