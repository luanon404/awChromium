...
class PeerConnectionManager_Internal {
    ...
    private static final int GET_CURRENT_STATE_ORDINAL = 7;
...
int peerConnectionLocalId) {
        ...
        public void getCurrentState(
            ...
            PeerConnectionManagerGetCurrentStateParams _message = new PeerConnectionManagerGetCurrentStateParams();


            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(GET_CURRENT_STATE_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_CURRENT_STATE_ORDINAL: {
    ...
    static final class PeerConnectionManagerGetCurrentStateParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PeerConnectionManagerGetCurrentStateParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static PeerConnectionManagerGetCurrentStateParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static PeerConnectionManagerGetCurrentStateParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new PeerConnectionManagerGetCurrentStateParams(elementsOrVersion);
