...
class CoreImplJni implements CoreImpl.Natives {
  ...
  @Override
  public int queryHandleSignalsState(CoreImpl caller, long mojoHandle, ByteBuffer signalsStateBuffer) {
    return (int) GEN_JNI.org_chromium_mojo_system_impl_CoreImpl_queryHandleSignalsState(caller, mojoHandle, signalsStateBuffer);
  }

  @Override
  public ResultAnd readData(CoreImpl caller, long mojoHandle, ByteBuffer elements, int elementsSize, int flags) {
  ...
  @Override
  public ResultAnd writeData(CoreImpl caller, long mojoHandle, ByteBuffer elements, int limit, int flags) {
    return (ResultAnd) GEN_JNI.org_chromium_mojo_system_impl_CoreImpl_writeData(caller, mojoHandle, elements, limit, flags);
  }

  @Override
  public int writeMessage(CoreImpl caller, long mojoHandle, ByteBuffer bytes, int numBytes, ByteBuffer handlesBuffer, int flags) {
    ...
    if (GEN_JNI.TESTING_ENABLED) {
      ...
      if (GEN_JNI.REQUIRE_MOCK) {
        throw new UnsupportedOperationException(
            "No mock found for the native implementation of CoreImpl.Natives. "
