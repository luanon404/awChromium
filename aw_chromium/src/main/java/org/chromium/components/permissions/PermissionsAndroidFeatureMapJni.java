...
public class PermissionsAndroidFeatureMapJni implements PermissionsAndroidFeatureMap.Natives {
    ...
    public static final JniStaticTestMocker<PermissionsAndroidFeatureMap.Natives> TEST_HOOKS = new JniStaticTestMocker<PermissionsAndroidFeatureMap.Natives>() {
        @Override
    ...
    public static PermissionsAndroidFeatureMap.Natives get() {
        if (GEN_JNI.TESTING_ENABLED) {
            ...
            if (GEN_JNI.REQUIRE_MOCK) {
                throw new UnsupportedOperationException("No mock found for the native implementation of PermissionsAndroidFeatureMap.Natives. " + "The current configuration requires implementations be mocked.");
            }
        }
