...
public interface IChildProcessService extends android.os.IInterface {
    ...
    java.lang.String DESCRIPTOR = "org.chromium.base.process_launcher.IChildProcessService";
    ...
    // child process, for validating that the parent is talking to a "matching"
    // process.
    android.content.pm.ApplicationInfo getAppInfo() throws android.os.RemoteException;
    ...
    // process. On error the bundle is silently ignored, disabling the memory
    // optimization.
    void consumeRelroBundle(android.os.Bundle bundle) throws android.os.RemoteException;
