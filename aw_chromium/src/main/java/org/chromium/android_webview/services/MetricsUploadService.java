    ...
    private final IMetricsUploadService.Stub mBinder = new IMetricsUploadService.Stub() {
        ...
        public int uploadMetricsLog(byte[] serializedLog, boolean useDefaultUploadQos) {
            ...
            switch (status) {
                ...
                // The Chromium metrics work with status codes in HTTP status codes so we will
                // convert these over.
                case -1:
                case 0:
                ...
                // treat an interruption in
                // {@link org.chromium.android_webview.metrics.AwMetricsLogUploader}
                case 14:
