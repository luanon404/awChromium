            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case WRITE_ORDINAL: {
                        ...
                        getImpl().write(data.filePath, data.blob, data.position, data.opReceiver, data.listener);
                        return true;
                    }
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case WRITE_SYNC_ORDINAL: {
                        ...
                        getImpl().writeSync(data.filePath, data.blob, data.position, new FileSystemManagerWriteSyncResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
