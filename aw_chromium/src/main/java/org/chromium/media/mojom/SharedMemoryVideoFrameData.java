// SharedMemoryVideoFrameData.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class SharedMemoryVideoFrameData extends org.chromium.mojo.bindings.Struct {

    private static final int STRUCT_SIZE = 32;
    private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(32, 0)};
    private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
    public org.chromium.mojo_base.mojom.ReadOnlySharedMemoryRegion frameData;
    public int[] strides;
    public int[] offsets;
    ...
    public static SharedMemoryVideoFrameData deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static SharedMemoryVideoFrameData deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static SharedMemoryVideoFrameData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        SharedMemoryVideoFrameData result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new SharedMemoryVideoFrameData(elementsOrVersion);
                {
                    
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                result.frameData = org.chromium.mojo_base.mojom.ReadOnlySharedMemoryRegion.decode(decoder1);
                }
                {
