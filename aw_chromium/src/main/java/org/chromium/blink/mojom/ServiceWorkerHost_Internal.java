...
RegisterRouter_Response callback) {
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case REGISTER_ROUTER_ORDINAL: {

                        ServiceWorkerHostRegisterRouterParams data =
                                ServiceWorkerHostRegisterRouterParams.deserialize(messageWithHeader.getPayload());

                        getImpl().registerRouter(data.rules, new ServiceWorkerHostRegisterRouterResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class ServiceWorkerHostRegisterRouterParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ServiceWorkerHostRegisterRouterParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ServiceWorkerHostRegisterRouterParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ServiceWorkerHostRegisterRouterParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ServiceWorkerHostRegisterRouterParams(elementsOrVersion);
                    {
    ...
    static final class ServiceWorkerHostRegisterRouterResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static ServiceWorkerHostRegisterRouterResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static ServiceWorkerHostRegisterRouterResponseParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static ServiceWorkerHostRegisterRouterResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new ServiceWorkerHostRegisterRouterResponseParams(elementsOrVersion);
    ...
    static class ServiceWorkerHostRegisterRouterResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final ServiceWorkerHost.RegisterRouter_Response mCallback;

        ServiceWorkerHostRegisterRouterResponseParamsForwardToCallback(ServiceWorkerHost.RegisterRouter_Response callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(REGISTER_ROUTER_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }
    ...
    static class ServiceWorkerHostRegisterRouterResponseParamsProxyToResponder implements ServiceWorkerHost.RegisterRouter_Response {
        ...
        @Override
        public void call() {
            ServiceWorkerHostRegisterRouterResponseParams _response = new ServiceWorkerHostRegisterRouterResponseParams();
