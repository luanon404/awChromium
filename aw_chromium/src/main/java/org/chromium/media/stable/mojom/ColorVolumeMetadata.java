// ColorVolumeMetadata.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class ColorVolumeMetadata extends org.chromium.mojo.bindings.Struct {
    ...
    public static ColorVolumeMetadata deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static ColorVolumeMetadata decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        ColorVolumeMetadata result;
        try {
