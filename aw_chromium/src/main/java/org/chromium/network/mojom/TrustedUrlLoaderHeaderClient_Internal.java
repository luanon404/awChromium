// TrustedUrlLoaderHeaderClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
UrlRequest request, org.chromium.mojo.bindings.InterfaceRequest<TrustedHeaderClient> headerClient) {
    ...
    static final class TrustedUrlLoaderHeaderClientOnLoaderCreatedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static TrustedUrlLoaderHeaderClientOnLoaderCreatedParams deserialize(org.chromium.mojo.bindings.Message message) {
        ...
        public static TrustedUrlLoaderHeaderClientOnLoaderCreatedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
    ...
    static final class TrustedUrlLoaderHeaderClientOnLoaderForCorsPreflightCreatedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static TrustedUrlLoaderHeaderClientOnLoaderForCorsPreflightCreatedParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static TrustedUrlLoaderHeaderClientOnLoaderForCorsPreflightCreatedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
