// PaymentRequestClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
AllowConnectToSource_Response callback) {
    ...
    static final class PaymentRequestClientOnPaymentMethodChangeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PaymentRequestClientOnPaymentMethodChangeParams deserialize(org.chromium.mojo.bindings.Message message) {
        ...
        public static PaymentRequestClientOnPaymentMethodChangeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
    ...
    static final class PaymentRequestClientOnPayerDetailChangeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PaymentRequestClientOnPayerDetailChangeParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static PaymentRequestClientOnPayerDetailChangeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
    ...
    static final class PaymentRequestClientAllowConnectToSourceParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PaymentRequestClientAllowConnectToSourceParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static PaymentRequestClientAllowConnectToSourceParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
    ...
    static final class PaymentRequestClientAllowConnectToSourceResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static PaymentRequestClientAllowConnectToSourceResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static PaymentRequestClientAllowConnectToSourceResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
    ...
    static class PaymentRequestClientAllowConnectToSourceResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                PaymentRequestClientAllowConnectToSourceResponseParams response = PaymentRequestClientAllowConnectToSourceResponseParams.deserialize(messageWithHeader.getPayload());

                mCallback.call(response.allow);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class PaymentRequestClientAllowConnectToSourceResponseParamsProxyToResponder implements PaymentRequestClient.AllowConnectToSource_Response {
        ...
        public void call(Boolean allow) {
            PaymentRequestClientAllowConnectToSourceResponseParams _response = new PaymentRequestClientAllowConnectToSourceResponseParams();
