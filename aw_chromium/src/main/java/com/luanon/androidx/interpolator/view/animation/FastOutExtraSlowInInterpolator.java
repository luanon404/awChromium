...
package com.luanon.androidx.interpolator.view.animation;
 ...
 * </pre></code>
 */
public class FastOutExtraSlowInInterpolator extends LookupTableInterpolator {
    ...
    public FastOutExtraSlowInInterpolator() {
        super(VALUES);
    }
}
