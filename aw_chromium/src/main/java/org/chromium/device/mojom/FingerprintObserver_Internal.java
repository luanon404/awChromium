...
FingerprintMessage msg, java.util.Map<String, String[]> matches) {
    ...
    static final class FingerprintObserverOnStatusChangedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static FingerprintObserverOnStatusChangedParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static FingerprintObserverOnStatusChangedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
