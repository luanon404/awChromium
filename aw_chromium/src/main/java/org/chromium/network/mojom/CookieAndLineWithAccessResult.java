// CookieAndLineWithAccessResult.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class CookieAndLineWithAccessResult extends org.chromium.mojo.bindings.Struct {
    ...
    public static CookieAndLineWithAccessResult deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static CookieAndLineWithAccessResult decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        CookieAndLineWithAccessResult result;
        try {
