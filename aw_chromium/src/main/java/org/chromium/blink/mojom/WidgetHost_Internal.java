...
org.chromium.ui.mojom.Cursor cursor) {
        ...
        @Override
        public void updateTooltipUnderCursor(
org.chromium.mojo_base.mojom.String16 tooltipText, int textDirectionHint) {

            WidgetHostUpdateTooltipUnderCursorParams _message = new WidgetHostUpdateTooltipUnderCursorParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(UPDATE_TOOLTIP_UNDER_CURSOR_ORDINAL)));
...
org.chromium.mojo_base.mojom.String16 tooltipText, int textDirectionHint, org.chromium.gfx.mojom.Rect bounds) {
            ...
            WidgetHostUpdateTooltipFromKeyboardParams _message = new WidgetHostUpdateTooltipFromKeyboardParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(UPDATE_TOOLTIP_FROM_KEYBOARD_ORDINAL)));
        ...
        public void clearKeyboardTriggeredTooltip(
            ...
            WidgetHostClearKeyboardTriggeredTooltipParams _message = new WidgetHostClearKeyboardTriggeredTooltipParams();


            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(CLEAR_KEYBOARD_TRIGGERED_TOOLTIP_ORDINAL)));
...
org.chromium.mojo.bindings.InterfaceRequest<org.chromium.cc.mojom.RenderFrameMetadataObserverClient> renderFrameMetadataObserverClientReceiver, org.chromium.cc.mojom.RenderFrameMetadataObserver renderFrameMetadataObserver) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case UPDATE_TOOLTIP_UNDER_CURSOR_ORDINAL: {

                        WidgetHostUpdateTooltipUnderCursorParams data =
                                WidgetHostUpdateTooltipUnderCursorParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case UPDATE_TOOLTIP_FROM_KEYBOARD_ORDINAL: {

                        WidgetHostUpdateTooltipFromKeyboardParams data =
                                WidgetHostUpdateTooltipFromKeyboardParams.deserialize(messageWithHeader.getPayload());

                        getImpl().updateTooltipFromKeyboard(data.tooltipText, data.textDirectionHint, data.bounds);
                        return true;
                    }
                    ...
                    case CLEAR_KEYBOARD_TRIGGERED_TOOLTIP_ORDINAL: {

                        WidgetHostClearKeyboardTriggeredTooltipParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case SELECTION_BOUNDS_CHANGED_ORDINAL: {
                        ...
                        getImpl().selectionBoundsChanged(data.anchorRect, data.anchorDir, data.focusRect, data.focusDir, data.boundingBoxRect, data.isAnchorFirst);
                        return true;
                    }
    ...
    static final class WidgetHostUpdateTooltipUnderCursorParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WidgetHostUpdateTooltipUnderCursorParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static WidgetHostUpdateTooltipUnderCursorParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static WidgetHostUpdateTooltipUnderCursorParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new WidgetHostUpdateTooltipUnderCursorParams(elementsOrVersion);
                    {
    ...
    static final class WidgetHostUpdateTooltipFromKeyboardParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WidgetHostUpdateTooltipFromKeyboardParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static WidgetHostUpdateTooltipFromKeyboardParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static WidgetHostUpdateTooltipFromKeyboardParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new WidgetHostUpdateTooltipFromKeyboardParams(elementsOrVersion);
                    {
    ...
    static final class WidgetHostClearKeyboardTriggeredTooltipParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WidgetHostClearKeyboardTriggeredTooltipParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static WidgetHostClearKeyboardTriggeredTooltipParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static WidgetHostClearKeyboardTriggeredTooltipParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new WidgetHostClearKeyboardTriggeredTooltipParams(elementsOrVersion);
    ...
    static final class WidgetHostSelectionBoundsChangedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public int focusDir;
        public org.chromium.gfx.mojom.Rect boundingBoxRect;
        ...
        public static WidgetHostSelectionBoundsChangedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new WidgetHostSelectionBoundsChangedParams(elementsOrVersion);
                    ...
                    result.boundingBoxRect = org.chromium.gfx.mojom.Rect.decode(decoder1);
                    }
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.boundingBoxRect, 32, false);
