...
class FrameSinkBundle_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<FrameSinkBundle, FrameSinkBundle.Proxy> MANAGER =
            new org.chromium.mojo.bindings.Interface.Manager<FrameSinkBundle, FrameSinkBundle.Proxy>() {
...
BundledFrameSubmission[] submissions) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(SUBMIT_ORDINAL)));
                ...
                switch(header.getType()) {
                    ...
                    case INITIALIZE_COMPOSITOR_FRAME_SINK_TYPE_ORDINAL: {
                        ...
                        FrameSinkBundleInitializeCompositorFrameSinkTypeParams data =
                                FrameSinkBundleInitializeCompositorFrameSinkTypeParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case SET_NEEDS_BEGIN_FRAME_ORDINAL: {
                        ...
                        FrameSinkBundleSetNeedsBeginFrameParams data =
                    ...
                    case SUBMIT_ORDINAL: {
                        ...
                        FrameSinkBundleSubmitParams data =
                    ...
                    case DID_ALLOCATE_SHARED_BITMAP_ORDINAL: {
                        ...
                        FrameSinkBundleDidAllocateSharedBitmapParams data =
                                FrameSinkBundleDidAllocateSharedBitmapParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case SET_THREAD_IDS_ORDINAL: {
                        ...
                        FrameSinkBundleSetThreadIdsParams data =
