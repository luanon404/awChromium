...
class ComponentLoaderPolicyBridgeJni implements ComponentLoaderPolicyBridge.Natives {
    ...
    public static final JniStaticTestMocker<ComponentLoaderPolicyBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<ComponentLoaderPolicyBridge.Natives>() {
        @Override
    ...
    public static ComponentLoaderPolicyBridge.Natives get() {
        if (GEN_JNI.TESTING_ENABLED) {
            ...
            if (GEN_JNI.REQUIRE_MOCK) {
                throw new UnsupportedOperationException("No mock found for the native implementation of ComponentLoaderPolicyBridge.Natives. " + "The current configuration requires implementations be mocked.");
            }
        }
