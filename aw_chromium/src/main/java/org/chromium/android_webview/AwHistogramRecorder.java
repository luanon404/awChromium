...
public class AwHistogramRecorder {
    ...
    @IntDef({WebViewCallbackType.ON_RECEIVED_LOGIN_REQUEST, WebViewCallbackType.ON_RECEIVED_CLIENT_CERT_REQUEST, WebViewCallbackType.ON_RECEIVED_HTTP_AUTH_REQUEST, WebViewCallbackType.ON_DOWNLOAD_START, WebViewCallbackType.ON_PAGE_STARTED, WebViewCallbackType.ON_PAGE_FINISHED, WebViewCallbackType.ON_LOAD_RESOURCE, WebViewCallbackType.ON_PAGE_COMMIT_VISIBLE, WebViewCallbackType.SHOULD_OVERRIDE_URL_LOADING, WebViewCallbackType.SHOULD_INTERCEPT_REQUEST, WebViewCallbackType.ON_RECEIVED_ERROR, WebViewCallbackType.ON_SAFE_BROWSING_HIT, WebViewCallbackType.ON_RECEIVED_HTTP_ERROR, WebViewCallbackType.GET_VISITED_HISTORY, WebViewCallbackType.DO_UPDATE_VISITED_HISTORY, WebViewCallbackType.ON_PROGRESS_CHANGED, WebViewCallbackType.ON_UNHANDLED_KEY_EVENT, WebViewCallbackType.ON_CONSOLE_MESSAGE, WebViewCallbackType.ON_CREATE_WINDOW, WebViewCallbackType.ON_CLOSE_WINDOW, WebViewCallbackType.ON_REQUEST_FOCUS, WebViewCallbackType.ON_RECEIVED_TOUCH_ICON_URL, WebViewCallbackType.ON_RECEIVED_ICON, WebViewCallbackType.ON_RECEIVED_TITLE, WebViewCallbackType.SHOULD_OVERRIDE_KEY_EVENT, WebViewCallbackType.ON_GEOLOCATION_PERMISSIONS_SHOW_PROMPT, WebViewCallbackType.ON_GEOLOCATION_PERMISSIONS_HIDE_PROMPT, WebViewCallbackType.ON_PERMISSION_REQUEST, WebViewCallbackType.ON_PERMISSION_REQUEST_CANCELED, WebViewCallbackType.ON_JS_ALERT, WebViewCallbackType.ON_JS_BEFORE_UNLOAD, WebViewCallbackType.ON_JS_CONFIRM, WebViewCallbackType.ON_JS_PROMPT, WebViewCallbackType.ON_RECEIVED_SSL_ERROR, WebViewCallbackType.ON_FORM_RESUBMISSION, WebViewCallbackType.ON_SHOW_CUSTOM_VIEW, WebViewCallbackType.ON_HIDE_CUSTOM_VIEW, WebViewCallbackType.GET_DEFAULT_VIDEO_POSTER, WebViewCallbackType.ON_RENDER_PROCESS_GONE, WebViewCallbackType.ON_SCALE_CHANGED, WebViewCallbackType.NUM_ENTRIES})
    ...
    public static void recordCallbackInvocation(@WebViewCallbackType int result) {
        RecordHistogram.recordEnumeratedHistogram("Android.WebView.Callback.Counts", result, WebViewCallbackType.NUM_ENTRIES);
    }
