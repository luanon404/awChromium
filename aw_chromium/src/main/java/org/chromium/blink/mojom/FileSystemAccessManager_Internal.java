...
GetEntryFromDataTransferToken_Response callback) {
        ...
        @Override
        public void bindObserverHost(
org.chromium.mojo.bindings.InterfaceRequest<FileSystemAccessObserverHost> observerHost) {

            FileSystemAccessManagerBindObserverHostParams _message = new FileSystemAccessManagerBindObserverHostParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(BIND_OBSERVER_HOST_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case BIND_OBSERVER_HOST_ORDINAL: {

                        FileSystemAccessManagerBindObserverHostParams data =
                                FileSystemAccessManagerBindObserverHostParams.deserialize(messageWithHeader.getPayload());

                        getImpl().bindObserverHost(data.observerHost);
                        return true;
                    }
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case CHOOSE_ENTRIES_ORDINAL: {
                        ...
                        getImpl().chooseEntries(data.options, new FileSystemAccessManagerChooseEntriesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class FileSystemAccessManagerGetEntryFromDataTransferTokenResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.entry, 16, true);
        }
    }
    ...
    static class FileSystemAccessManagerGetEntryFromDataTransferTokenResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                mCallback.call(response.result, response.entry);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static final class FileSystemAccessManagerBindObserverHostParams extends org.chromium.mojo.bindings.Struct {

        private static final int STRUCT_SIZE = 16;
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo.bindings.InterfaceRequest<FileSystemAccessObserverHost> observerHost;
        ...
        public static FileSystemAccessManagerBindObserverHostParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static FileSystemAccessManagerBindObserverHostParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static FileSystemAccessManagerBindObserverHostParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new FileSystemAccessManagerBindObserverHostParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.observerHost, 8, false);
        }
    }
