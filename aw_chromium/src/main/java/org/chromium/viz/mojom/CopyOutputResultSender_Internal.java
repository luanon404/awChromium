...
class CopyOutputResultSender_Internal {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements CopyOutputResultSender.Proxy {
        ...
        public void sendResult(CopyOutputResult result) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(SEND_RESULT_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(CopyOutputResultSender_Internal.MANAGER, messageWithHeader);


                    case SEND_RESULT_ORDINAL: {

                        CopyOutputResultSenderSendResultParams data = CopyOutputResultSenderSendResultParams.deserialize(messageWithHeader.getPayload());
