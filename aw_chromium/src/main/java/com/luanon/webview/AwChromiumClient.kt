...
open class AwChromiumClient @JvmOverloads constructor(looper: Looper = ThreadUtils.getUiThreadLooper()) :
    ...
    override fun onReceivedError2(request: AwWebResourceRequest?, error: AwWebResourceError?) {
    }
    ...
    override fun onCreateWindow(isDialog: Boolean, isUserGesture: Boolean): Boolean = false
    ...
    override val videoLoadingProgressView: View? = null

    override val defaultVideoPoster: Bitmap? = null
