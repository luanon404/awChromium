...
public final class SslConfig extends org.chromium.mojo.bindings.Struct {
    ...
    private SslConfig(int version) {
        ...
        this.postQuantumOverride = (int) OptionalBool.UNSET;
        this.echEnabled = (boolean) true;
        this.insecureHashOverride = (int) OptionalBool.UNSET;
        this.rsaKeyUsageForLocalAnchorsOverride = (int) OptionalBool.UNSET;
    }
