...
public interface IJsSandboxIsolate extends android.os.IInterface
{
  ...
  public static class Default implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolate
  {
    /**
     ...
     * from the sandbox.
     */
    @Override public void evaluateJavascript(java.lang.String code, org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateCallback callback) throws android.os.RemoteException
    {
    }
     ...
     */
    @Override public boolean provideNamedData(java.lang.String name, android.content.res.AssetFileDescriptor afd) throws android.os.RemoteException
    {
      return false;
    }
    /**
     ...
     *                 from the sandbox.
     */
    @Override public void evaluateJavascriptWithFd(android.content.res.AssetFileDescriptor afd, org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateSyncCallback callback) throws android.os.RemoteException
    {
    }
    /**
     ...
     */
    @Override public void setConsoleCallback(org.chromium.android_webview.js_sandbox.common.IJsSandboxConsoleCallback callback) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolate
  {
  ...
  public static final java.lang.String DESCRIPTOR = "org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolate";
  /**
   * @param code the JavaScript code
   * to be evaluated in the sandbox.
   * @param callback used to pass the information back to the embedding app
