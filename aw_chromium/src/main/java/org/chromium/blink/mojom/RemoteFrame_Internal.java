...
org.chromium.url.internal.mojom.Origin origin, boolean isPotentiallyTrustworthyUniqueOrigin) {
        ...
        @Override
        public void setReplicatedIsAdFrame(
boolean isAdFrame) {

            RemoteFrameSetReplicatedIsAdFrameParams _message = new RemoteFrameSetReplicatedIsAdFrameParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(SET_REPLICATED_IS_AD_FRAME_ORDINAL)));
...
RemoteFrameToken token, FrameToken openerFrameToken, int treeScopeType, FrameReplicationState replicationState, FrameOwnerProperties ownerProperties, boolean isLoading, org.chromium.mojo_base.mojom.UnguessableToken devtoolsFrameToken, RemoteFrameInterfacesFromBrowser remoteFrameInterfaces) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(CREATE_REMOTE_CHILD_ORDINAL)));

        }


        @Override
        public void createRemoteChildren(
CreateRemoteChildParams[] params) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(CREATE_REMOTE_CHILDREN_ORDINAL)));
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case SET_REPLICATED_IS_AD_FRAME_ORDINAL: {

                        RemoteFrameSetReplicatedIsAdFrameParams data =
                                RemoteFrameSetReplicatedIsAdFrameParams.deserialize(messageWithHeader.getPayload());

                        getImpl().setReplicatedIsAdFrame(data.isAdFrame);
                        return true;
                    }
                    ...
                    case CREATE_REMOTE_CHILD_ORDINAL: {

                        RemoteFrameCreateRemoteChildParams data =
                                RemoteFrameCreateRemoteChildParams.deserialize(messageWithHeader.getPayload());

                        getImpl().createRemoteChild(data.token, data.openerFrameToken, data.treeScopeType, data.replicationState, data.ownerProperties, data.isLoading, data.devtoolsFrameToken, data.remoteFrameInterfaces);
                        return true;
                    }
                    ...
                    case CREATE_REMOTE_CHILDREN_ORDINAL: {

                        RemoteFrameCreateRemoteChildrenParams data =
                                RemoteFrameCreateRemoteChildrenParams.deserialize(messageWithHeader.getPayload());

                        getImpl().createRemoteChildren(data.params);
                        return true;
                    }
    ...
    static final class RemoteFrameSetReplicatedIsAdFrameParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteFrameSetReplicatedIsAdFrameParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static RemoteFrameSetReplicatedIsAdFrameParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static RemoteFrameSetReplicatedIsAdFrameParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new RemoteFrameSetReplicatedIsAdFrameParams(elementsOrVersion);
                    {
    ...
    static final class RemoteFrameCreateRemoteChildParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteFrameCreateRemoteChildParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static RemoteFrameCreateRemoteChildParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static RemoteFrameCreateRemoteChildParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new RemoteFrameCreateRemoteChildParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.remoteFrameInterfaces, 64, false);
        }
    }
    ...
    static final class RemoteFrameCreateRemoteChildrenParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static RemoteFrameCreateRemoteChildrenParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static RemoteFrameCreateRemoteChildrenParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static RemoteFrameCreateRemoteChildrenParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new RemoteFrameCreateRemoteChildrenParams(elementsOrVersion);
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            if (this.params == null) {
                ...
                org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.params.length, 8, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                for (int i0 = 0; i0 < this.params.length; ++i0) {
                    
                    encoder1.encode(this.params[i0], org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i0, false);
                }
            }
        }
    }
