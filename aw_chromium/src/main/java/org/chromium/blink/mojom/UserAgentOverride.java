// UserAgentOverride.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class UserAgentOverride extends org.chromium.mojo.bindings.Struct {
    ...
    public static UserAgentOverride deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static UserAgentOverride deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static UserAgentOverride decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        ...
        try {
            ...
            result = new UserAgentOverride(elementsOrVersion);
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.uaMetadataOverride, 16, true);
    }
}