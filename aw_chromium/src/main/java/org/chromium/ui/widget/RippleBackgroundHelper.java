...
public class RippleBackgroundHelper {
    ...
    private static final int[] STATE_SET_SELECTED_PRESSED = {android.R.attr.state_selected, android.R.attr.state_pressed};
     ...
     */
    RippleBackgroundHelper(View view, @ColorRes int backgroundColorResId, @ColorRes int rippleColorResId, @Px int cornerRadius, @Px int verticalInset) {
        this(view, backgroundColorResId, rippleColorResId, cornerRadius, android.R.color.transparent, R.dimen.default_ripple_background_border_size, verticalInset);
    }
     ...
     * @param verticalInset        The vertical inset of the background drawable.
     */
    RippleBackgroundHelper(View view, @ColorRes int backgroundColorResId, @ColorRes int rippleColorResId, float[] cornerRadii, @Px int verticalInset) {
        this(view, backgroundColorResId, rippleColorResId, cornerRadii, android.R.color.transparent, R.dimen.default_ripple_background_border_size, verticalInset);
    }
     ...
     * @param verticalInset        The vertical inset of the background drawable.
     */
    RippleBackgroundHelper(View view, @ColorRes int backgroundColorResId, @ColorRes int rippleColorResId, @Px int cornerRadius, @ColorRes int borderColorResId, @DimenRes int borderSizeDimenId, @Px int verticalInset) {
        this(view, backgroundColorResId, rippleColorResId, new float[]{cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius}, borderColorResId, borderSizeDimenId, verticalInset);
    }
     ...
     * @param verticalInset        The vertical inset of the background drawable.
     */
    public RippleBackgroundHelper(View view, @ColorRes int backgroundColorResId, @ColorRes int stateLayerColorResId, @ColorRes int rippleColorResId, @Px int cornerRadius, @ColorRes int borderColorResId, @DimenRes int borderSizeDimenId, @Px int verticalInset) {
        this(view, backgroundColorResId, rippleColorResId, cornerRadius, borderColorResId, borderSizeDimenId, verticalInset);
        setStateLayerColor(AppCompatResources.getColorStateList(view.getContext(), stateLayerColorResId));
    }
     ...
     * @param verticalInset        The vertical inset of the background drawable.
     */
    RippleBackgroundHelper(View view, @ColorRes int backgroundColorResId, @ColorRes int rippleColorResId, float[] cornerRadii, @ColorRes int borderColorResId, @DimenRes int borderSizeDimenId, @Px int verticalInset) {
        mView = view;
        mView.setBackground(createBackgroundDrawable(AppCompatResources.getColorStateList(view.getContext(), rippleColorResId), AppCompatResources.getColorStateList(view.getContext(), borderColorResId), view.getResources().getDimensionPixelSize(borderSizeDimenId), cornerRadii, verticalInset));
        setBackgroundColor(AppCompatResources.getColorStateList(view.getContext(), backgroundColorResId));
    }
     ...
     */
    private Drawable createBackgroundDrawable(ColorStateList rippleColorList, ColorStateList borderColorList, @Px int borderSize, float[] cornerRadii, @Px int verticalInset) {
        ...
        mBackgroundLayerDrawable = new LayerDrawable(new Drawable[]{mBackgroundGradient, mStateLayerGradient});
        ...
        return new RippleDrawable(convertToRippleDrawableColorList(rippleColorList), wrapDrawableWithInsets(mBackgroundLayerDrawable, verticalInset), mask);
    }
     ...
     * @return The {@link GradientDrawable}/{@link LayerDrawable} to be used as ripple background.
     */
    private Drawable createBackgroundDrawable(ColorStateList rippleColorList, ColorStateList borderColorList, @Px int borderSize, @Px int cornerRadius, @Px int verticalInset) {
        return createBackgroundDrawable(rippleColorList, borderColorList, borderSize, new float[]{cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius, cornerRadius}, verticalInset);
    }
     ...
     */
    private @ColorInt
    static int doubleAlpha(@ColorInt int color) {
