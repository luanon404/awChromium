...
class EventForwarderJni implements EventForwarder.Natives {
    ...
    public static final JniStaticTestMocker<EventForwarder.Natives> TEST_HOOKS = new JniStaticTestMocker<EventForwarder.Natives>() {
        @Override
    ...
    @Override
    public void onDragEvent(long nativeEventForwarder, EventForwarder caller, int action, float x, float y, float screenX, float screenY, String[] mimeTypes, String content) {
    ...
    @Override
    public boolean onGenericMotionEvent(long nativeEventForwarder, EventForwarder caller, MotionEvent event, long timeNs) {
        return (boolean) GEN_JNI.org_chromium_ui_base_EventForwarder_onGenericMotionEvent(nativeEventForwarder, caller, event, timeNs);
    }
    ...
    @Override
    public void onMouseEvent(long nativeEventForwarder, EventForwarder caller, long timeNs, int action, float x, float y, int pointerId, float pressure, float orientation, float tilt, int changedButton, int buttonState, int metaState, int toolType) {
        GEN_JNI.org_chromium_ui_base_EventForwarder_onMouseEvent(nativeEventForwarder, caller, timeNs, action, x, y, pointerId, pressure, orientation, tilt, changedButton, buttonState, metaState, toolType);
    }
