...
public final class VideoCaptureFrameDropReason {
    ...
    @IntDef({
        ...
        VideoCaptureFrameDropReason.RESOLUTION_ADAPTER_TIMESTAMP_TOO_CLOSE_TO_PREVIOUS_DEPRECATED,
        ...
        VideoCaptureFrameDropReason.CROP_VERSION_NOT_CURRENT,
        VideoCaptureFrameDropReason.GPU_MEMORY_BUFFER_MAP_FAILED})
