...
public abstract class WebContentsObserver {
     ...
     *
     * @param navigationHandle NavigationHandle are provided to several WebContentsObserver methods to allow
     ...
     *
     * @param navigationHandle NavigationHandle are proided to several WebContentsObserver methods to allow
     *                         observers to track specific navigations. Observers should clear any references to a
     *                         NavigationHandle at didFinishNavigationInPrimaryMainFrame();
     */
