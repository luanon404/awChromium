// WebSocketAuthenticationHandler_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class WebSocketAuthenticationHandler_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<WebSocketAuthenticationHandler, WebSocketAuthenticationHandler.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<WebSocketAuthenticationHandler, WebSocketAuthenticationHandler.Proxy>() {
        ...
        @Override
        public Stub buildStub(org.chromium.mojo.system.Core core, WebSocketAuthenticationHandler impl) {
    ...
    static final class Stub extends org.chromium.mojo.bindings.Interface.Stub<WebSocketAuthenticationHandler> {

        Stub(org.chromium.mojo.system.Core core, WebSocketAuthenticationHandler impl) {
            super(core, impl);
        }
    ...
    static final class WebSocketAuthenticationHandlerOnAuthRequiredParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WebSocketAuthenticationHandlerOnAuthRequiredParams deserialize(org.chromium.mojo.bindings.Message message) {
        ...
        public static WebSocketAuthenticationHandlerOnAuthRequiredParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
    ...
    static final class WebSocketAuthenticationHandlerOnAuthRequiredResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WebSocketAuthenticationHandlerOnAuthRequiredResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static WebSocketAuthenticationHandlerOnAuthRequiredResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
