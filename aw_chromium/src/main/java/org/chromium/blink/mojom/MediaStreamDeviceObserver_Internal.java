...
String label, MediaStreamDevice device, int newState) {
        ...
        @Override
        public void onDeviceCaptureConfigurationChange(
String label, MediaStreamDevice device) {

            MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams _message = new MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams();
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(ON_DEVICE_CAPTURE_CONFIGURATION_CHANGE_ORDINAL)));
...
String label, MediaStreamDevice device) {
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ON_DEVICE_CAPTURE_CONFIGURATION_CHANGE_ORDINAL: {

                        MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams data =
                                MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams.deserialize(messageWithHeader.getPayload());

                        getImpl().onDeviceCaptureConfigurationChange(data.label, data.device);
                        return true;
                    }
    ...
    static final class MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new MediaStreamDeviceObserverOnDeviceCaptureConfigurationChangeParams(elementsOrVersion);
                    {
