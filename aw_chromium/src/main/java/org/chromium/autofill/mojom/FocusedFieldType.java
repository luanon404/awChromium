...
public final class FocusedFieldType {
    ...
    @IntDef({
        ...
        FocusedFieldType.FILLABLE_WEBAUTHN_TAGGED_FIELD,
    ...
    public static final int FILLABLE_WEBAUTHN_TAGGED_FIELD = 5;
    public static final int FILLABLE_USERNAME_FIELD = 6;
    public static final int FILLABLE_PASSWORD_FIELD = 7;
