// GestureSwipeData.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class GestureSwipeData extends org.chromium.mojo.bindings.Struct {
    ...
    public static GestureSwipeData deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static GestureSwipeData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        GestureSwipeData result;
        try {
