// GeolocationContext_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
GeopositionResult result) {
    ...
    static final class GeolocationContextOnPermissionRevokedParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static GeolocationContextOnPermissionRevokedParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
        ...
        @SuppressWarnings("unchecked")
        public static GeolocationContextOnPermissionRevokedParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
