...
public class KeyboardShortcutRecorder {
    ...
    @IntDef({KeyboardShortcut.ZOOM_IN, KeyboardShortcut.ZOOM_OUT, KeyboardShortcut.ZOOM_RESET, KeyboardShortcut.DELETE_LINE, KeyboardShortcut.PAGE_UP, KeyboardShortcut.PAGE_DOWN, KeyboardShortcut.COUNT})
    ...
    public static void recordKeyboardShortcut(@KeyboardShortcut int keyboardShortcut) {
        RecordHistogram.recordEnumeratedHistogram("InputMethod.PhysicalKeyboard.KeyboardShortcut", keyboardShortcut, KeyboardShortcut.COUNT);
    }
}
