// DirectoryPickerOptions.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class DirectoryPickerOptions extends org.chromium.mojo.bindings.Struct {
    ...
    public static DirectoryPickerOptions deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static DirectoryPickerOptions deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static DirectoryPickerOptions decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        DirectoryPickerOptions result;
        try {
