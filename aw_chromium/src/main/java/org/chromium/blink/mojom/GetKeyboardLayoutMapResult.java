// GetKeyboardLayoutMapResult.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class GetKeyboardLayoutMapResult extends org.chromium.mojo.bindings.Struct {

    private static final int STRUCT_SIZE = 24;
    private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(24, 0)};
    private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
    public int status;
    public java.util.Map<String, String> layoutMap;
    ...
    public static GetKeyboardLayoutMapResult deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static GetKeyboardLayoutMapResult deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static GetKeyboardLayoutMapResult decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        GetKeyboardLayoutMapResult result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new GetKeyboardLayoutMapResult(elementsOrVersion);
                {
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(16, false);
                {
                    ...
                    result.layoutMap = new java.util.HashMap<String, String>();
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.layoutMap == null) {
            ...
            int index0 = 0;
            for (java.util.Map.Entry<String, String> entry0 : this.layoutMap.entrySet()) {
