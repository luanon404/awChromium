...
public class ModalDialogProperties {
    ...
    @IntDef({ModalDialogProperties.ButtonType.POSITIVE, ModalDialogProperties.ButtonType.NEGATIVE, ModalDialogProperties.ButtonType.TITLE_ICON})
     ...
     */
    @IntDef({ModalDialogProperties.ButtonStyles.PRIMARY_OUTLINE_NEGATIVE_OUTLINE, ModalDialogProperties.ButtonStyles.PRIMARY_FILLED_NEGATIVE_OUTLINE, ModalDialogProperties.ButtonStyles.PRIMARY_OUTLINE_NEGATIVE_FILLED})
    @Retention(RetentionPolicy.SOURCE)
     ...
     */
    @IntDef({DialogStyles.NORMAL, DialogStyles.FULLSCREEN_DIALOG, DialogStyles.FULLSCREEN_DARK_DIALOG, DialogStyles.DIALOG_WHEN_LARGE})
    @Retention(RetentionPolicy.SOURCE)
     ...
     */
    public static final ReadableObjectPropertyKey<Controller> CONTROLLER = new ReadableObjectPropertyKey<>();

    /**
     * The content description of the dialog for accessibility.
     */
    public static final ReadableObjectPropertyKey<String> CONTENT_DESCRIPTION = new ReadableObjectPropertyKey<>();
     ...
     */
    public static final WritableObjectPropertyKey<Drawable> TITLE_ICON = new WritableObjectPropertyKey<>();

    /**
     * The message paragraph 1 of the dialog.
     */
    public static final WritableObjectPropertyKey<CharSequence> MESSAGE_PARAGRAPH_1 = new WritableObjectPropertyKey<>();

    /**
     * The message paragraph 2 of the dialog. Shown below the paragraph 1 when both are set.
     */
    public static final WritableObjectPropertyKey<CharSequence> MESSAGE_PARAGRAPH_2 = new WritableObjectPropertyKey<>();

    /**
     * The customized content view of the dialog.
     */
    public static final WritableObjectPropertyKey<View> CUSTOM_VIEW = new WritableObjectPropertyKey<>();

    /**
     * The customized view replacing the button bar of the dialog.
     */
    public static final WritableObjectPropertyKey<View> CUSTOM_BUTTON_BAR_VIEW = new WritableObjectPropertyKey<>();

    /**
     * The text on the positive button.
     */
    public static final WritableObjectPropertyKey<String> POSITIVE_BUTTON_TEXT = new WritableObjectPropertyKey<>();

    /**
     * Content description for the positive button.
     */
    public static final WritableObjectPropertyKey<String> POSITIVE_BUTTON_CONTENT_DESCRIPTION = new WritableObjectPropertyKey<>();

    /**
     * The enabled state on the positive button.
     */
    public static final WritableBooleanPropertyKey POSITIVE_BUTTON_DISABLED = new WritableBooleanPropertyKey();

    /**
     * The text on the negative button.
     */
    public static final WritableObjectPropertyKey<String> NEGATIVE_BUTTON_TEXT = new WritableObjectPropertyKey<>();

    /**
     * Content description for the negative button.
     */
    public static final WritableObjectPropertyKey<String> NEGATIVE_BUTTON_CONTENT_DESCRIPTION = new WritableObjectPropertyKey<>();

    /**
     * The enabled state on the negative button.
     */
    public static final WritableBooleanPropertyKey NEGATIVE_BUTTON_DISABLED = new WritableBooleanPropertyKey();

    /**
     * The message on the dialog footer.
     */
    public static final WritableObjectPropertyKey<CharSequence> FOOTER_MESSAGE = new WritableObjectPropertyKey<>();

    /**
     * Whether the dialog should be dismissed on user tapping the scrim.
     */
    public static final WritableBooleanPropertyKey CANCEL_ON_TOUCH_OUTSIDE = new WritableBooleanPropertyKey();

    /**
     * Whether button touch events should be filtered when buttons are obscured by another visible
     * window.
     */
    public static final ReadableBooleanPropertyKey FILTER_TOUCH_FOR_SECURITY = new ReadableBooleanPropertyKey();

    /**
     * Callback to be called when the modal dialog filters touch events because the buttons are
     * obscured by another window.
     */
    public static final ReadableObjectPropertyKey<Runnable> TOUCH_FILTERED_CALLBACK = new ReadableObjectPropertyKey<>();

    /**
     * Whether the title is scrollable with the message.
     */
    public static final WritableBooleanPropertyKey TITLE_SCROLLABLE = new WritableBooleanPropertyKey();
     ...
     */
    public static final WritableObjectPropertyKey<OnBackPressedCallback> APP_MODAL_DIALOG_BACK_PRESS_HANDLER = new WritableObjectPropertyKey();
     ...
     */
    public static final WritableLongPropertyKey BUTTON_TAP_PROTECTION_PERIOD_MS = new WritableLongPropertyKey();

    public static final PropertyKey[] ALL_KEYS = new PropertyKey[]{CONTROLLER, CONTENT_DESCRIPTION, TITLE, TITLE_MAX_LINES, TITLE_ICON, MESSAGE_PARAGRAPH_1, MESSAGE_PARAGRAPH_2, CUSTOM_VIEW, CUSTOM_BUTTON_BAR_VIEW, POSITIVE_BUTTON_TEXT, POSITIVE_BUTTON_CONTENT_DESCRIPTION, POSITIVE_BUTTON_DISABLED, NEGATIVE_BUTTON_TEXT, NEGATIVE_BUTTON_CONTENT_DESCRIPTION, NEGATIVE_BUTTON_DISABLED, FOOTER_MESSAGE, CANCEL_ON_TOUCH_OUTSIDE, FILTER_TOUCH_FOR_SECURITY, TOUCH_FILTERED_CALLBACK, TITLE_SCROLLABLE, BUTTON_STYLES, DIALOG_STYLES, FOCUS_DIALOG, APP_MODAL_DIALOG_BACK_PRESS_HANDLER, BUTTON_TAP_PROTECTION_PERIOD_MS};
}
