// FirstPartySetsContextConfig.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class FirstPartySetsContextConfig extends org.chromium.mojo.bindings.Struct {
    ...
    public static FirstPartySetsContextConfig deserialize(org.chromium.mojo.bindings.Message message) {
    ...
    public static FirstPartySetsContextConfig decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        FirstPartySetsContextConfig result;
        try {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.customizations == null) {
            ...
            int index0 = 0;
            for (java.util.Map.Entry<SchemefulSite, FirstPartySetEntryOverride> entry0 : this.customizations.entrySet()) {
