...
class CdmService_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<CdmService, CdmService.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<CdmService, CdmService.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements CdmService.Proxy {
        ...
        @Override
        public void createCdmFactory(org.chromium.mojo.bindings.InterfaceRequest<CdmFactory> factory, FrameInterfaceFactory frameInterfaces) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(CREATE_CDM_FACTORY_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(CdmService_Internal.MANAGER, messageWithHeader);


                    case CREATE_CDM_FACTORY_ORDINAL: {

                        CdmServiceCreateCdmFactoryParams data = CdmServiceCreateCdmFactoryParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), CdmService_Internal.MANAGER, messageWithHeader, receiver);
