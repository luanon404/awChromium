...
class SubKeyRequesterJni implements SubKeyRequester.Natives {
    ...
    public static final JniStaticTestMocker<SubKeyRequester.Natives> TEST_HOOKS = new JniStaticTestMocker<SubKeyRequester.Natives>() {
        @Override
    ...
    public static SubKeyRequester.Natives get() {
        if (GEN_JNI.TESTING_ENABLED) {
            ...
            if (GEN_JNI.REQUIRE_MOCK) {
                throw new UnsupportedOperationException("No mock found for the native implementation of SubKeyRequester.Natives. " + "The current configuration requires implementations be mocked.");
            }
        }
