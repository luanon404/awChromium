...
public class GwpAsanFeatureMapJni implements GwpAsanFeatureMap.Natives {
  ...
  public static final JniStaticTestMocker<GwpAsanFeatureMap.Natives> TEST_HOOKS =
      new JniStaticTestMocker<GwpAsanFeatureMap.Natives>() {
    @Override
    ...
    if (GEN_JNI.TESTING_ENABLED) {
      ...
      if (GEN_JNI.REQUIRE_MOCK) {
        throw new UnsupportedOperationException(
            "No mock found for the native implementation of GwpAsanFeatureMap.Natives. "
