...
public interface IMetricsUploadService extends android.os.IInterface {
     ...
     */
    class Default implements org.chromium.android_webview.common.services.IMetricsUploadService {
        /**
     ...
     */
    abstract class Stub extends android.os.Binder implements org.chromium.android_webview.common.services.IMetricsUploadService {
        /**
    ...
    java.lang.String DESCRIPTOR = "org.chromium.android_webview.common.services.IMetricsUploadService";
     ...
     * platform.
     */
    int uploadMetricsLog(byte[] serializedLog, boolean useDefaultUploadQos) throws android.os.RemoteException;
}
