...
public final class ApiHelperForP {
     ...
     */
    public static boolean hasSigningCertificate(PackageManager pm, String packageName, byte[] certificate, int type) {
     ...
     */
    public static TextSelection.Request.Builder newTextSelectionRequestBuilder(CharSequence text, int startIndex, int endIndex) {
     ...
     */
    public static TextSelection.Request.Builder setDefaultLocales(TextSelection.Request.Builder builder, LocaleList defaultLocales) {
