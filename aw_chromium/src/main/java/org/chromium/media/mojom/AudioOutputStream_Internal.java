// AudioOutputStream_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class AudioOutputStream_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<AudioOutputStream, AudioOutputStream.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<AudioOutputStream, AudioOutputStream.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements AudioOutputStream.Proxy {
        ...
        public void play() {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(PLAY_ORDINAL)));
        ...
        public void flush() {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(FLUSH_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(AudioOutputStream_Internal.MANAGER, messageWithHeader);
                    ...
                    case SET_VOLUME_ORDINAL: {
                        ...
                        AudioOutputStreamSetVolumeParams data = AudioOutputStreamSetVolumeParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), AudioOutputStream_Internal.MANAGER, messageWithHeader, receiver);
    ...
    static final class AudioOutputStreamFlushParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static AudioOutputStreamFlushParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static AudioOutputStreamFlushParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static AudioOutputStreamFlushParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
