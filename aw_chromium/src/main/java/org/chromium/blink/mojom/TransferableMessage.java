...
public final class TransferableMessage extends org.chromium.mojo.bindings.Struct {
    ...
    public static TransferableMessage decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new TransferableMessage(elementsOrVersion);
                ...
                {
                    org.chromium.mojo.bindings.DataHeader si1 = decoder1.readDataHeaderForPointerArray(org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                    result.imageBitmapContentsArray = new SerializedStaticBitmapImage[si1.elementsOrVersion];
                    for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {
                        
                        result.imageBitmapContentsArray[i1] = SerializedStaticBitmapImage.decode(decoder1, org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + 
                ...
                result.parentTaskId = TaskAttributionId.decode(decoder1);
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.imageBitmapContentsArray == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodeUnionArray(this.imageBitmapContentsArray.length, 40, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
            for (int i0 = 0; i0 < this.imageBitmapContentsArray.length; ++i0) {
                
                encoder1.encode(this.imageBitmapContentsArray[i0], org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + 
        ...
        encoder0.encode(this.parentTaskId, 64, true);
    }
}