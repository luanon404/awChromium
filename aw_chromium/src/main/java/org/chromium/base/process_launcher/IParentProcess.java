...
public interface IParentProcess extends android.os.IInterface {
    ...
    java.lang.String DESCRIPTOR = "org.chromium.base.process_launcher.IParentProcess";
    ...
    // or its app zygote did not produce a usable shared region containing
    // linker relocations (RELRO FD).
    void finishSetupConnection(int pid, int zygotePid, long zygoteStartupTimeMillis, android.os.Bundle relroBundle) throws android.os.RemoteException;
