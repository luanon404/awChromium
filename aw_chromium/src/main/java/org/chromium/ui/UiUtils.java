...
public class UiUtils {
    ...
    public static Set<String> getIMELocales(Context context) {
        ...
        for (int i = 0; i < enabledMethods.size(); i++) {
            List<InputMethodSubtype> subtypes = imManager.getEnabledInputMethodSubtypeList(enabledMethods.get(i), true);
     ...
     */
    public static Drawable getTintedDrawable(Context context, @DrawableRes int drawableId, @ColorRes int tintColorId) {
        return getTintedDrawable(context, drawableId, AppCompatResources.getColorStateList(context, tintColorId));
    }
     ...
     */
    public static Drawable getTintedDrawable(Context context, @DrawableRes int drawableId, ColorStateList list) {
    ...
    public static boolean isSystemUiThemingDisabled() {
        if (sSystemUiThemingDisabled == null) {
            ...
            if (sAndroidUiThemeBlocklist.containsKey(Build.MANUFACTURER.toLowerCase(Locale.US))) {
                sSystemUiThemingDisabled = Build.VERSION.SDK_INT < sAndroidUiThemeBlocklist.get(Build.MANUFACTURER.toLowerCase(Locale.US));
            }
        }
    ...
    public static void setStatusBarColor(Window window, int statusBarColor) {
        if (0 == (window.getAttributes().flags & WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS)) {
    ...
    public static boolean isHardwareKeyboardAttached() {
        return ContextUtils.getApplicationContext().getResources().getConfiguration().keyboard != Configuration.KEYBOARD_NOKEYS;
    }
}
