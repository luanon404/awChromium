// HidManagerClient_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class HidManagerClient_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<HidManagerClient, HidManagerClient.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<HidManagerClient, HidManagerClient.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements HidManagerClient.Proxy {
        ...
        public void deviceAdded(HidDeviceInfo deviceInfo) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(DEVICE_ADDED_ORDINAL)));
        ...
        public void deviceRemoved(HidDeviceInfo deviceInfo) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(DEVICE_REMOVED_ORDINAL)));
        ...
        public void deviceChanged(HidDeviceInfo deviceInfo) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(DEVICE_CHANGED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(HidManagerClient_Internal.MANAGER, messageWithHeader);
                    ...
                    case DEVICE_REMOVED_ORDINAL: {
                        ...
                        HidManagerClientDeviceRemovedParams data = HidManagerClientDeviceRemovedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case DEVICE_CHANGED_ORDINAL: {
                        ...
                        HidManagerClientDeviceChangedParams data = HidManagerClientDeviceChangedParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), HidManagerClient_Internal.MANAGER, messageWithHeader, receiver);
