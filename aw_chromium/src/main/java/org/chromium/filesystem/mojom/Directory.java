...
public interface Directory extends org.chromium.mojo.bindings.Interface {
    ...
    void openFileHandle(String path, int openFlags, OpenFileHandle_Response callback);
    ...
    void statFile(String path, StatFile_Response callback);

    interface StatFile_Response extends org.chromium.mojo.bindings.Callbacks.Callback2<Integer, FileInformation> {
    }


    void clone(org.chromium.mojo.bindings.InterfaceRequest<Directory> directory);


    void readEntireFile(String path, ReadEntireFile_Response callback);

    interface ReadEntireFile_Response extends org.chromium.mojo.bindings.Callbacks.Callback2<Integer, byte[]> {
    }


    void writeFile(String path, byte[] data, WriteFile_Response callback);
