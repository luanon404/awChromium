// ServiceManagerListener_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class ServiceManagerListener_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<ServiceManagerListener, ServiceManagerListener.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<ServiceManagerListener, ServiceManagerListener.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements ServiceManagerListener.Proxy {
        ...
        public void onInit(RunningServiceInfo[] runningServices) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_INIT_ORDINAL)));
        ...
        public void onServiceCreated(RunningServiceInfo service) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_SERVICE_CREATED_ORDINAL)));
        ...
        public void onServiceStarted(Identity identity, int pidDeprecated) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_SERVICE_STARTED_ORDINAL)));
        ...
        public void onServicePidReceived(Identity identity, int pid) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_SERVICE_PID_RECEIVED_ORDINAL)));
        ...
        public void onServiceFailedToStart(Identity identity) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_SERVICE_FAILED_TO_START_ORDINAL)));
        ...
        public void onServiceStopped(Identity identity) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(ON_SERVICE_STOPPED_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(ServiceManagerListener_Internal.MANAGER, messageWithHeader);
                    ...
                    case ON_SERVICE_CREATED_ORDINAL: {
                        ...
                        ServiceManagerListenerOnServiceCreatedParams data = ServiceManagerListenerOnServiceCreatedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_SERVICE_STARTED_ORDINAL: {
                        ...
                        ServiceManagerListenerOnServiceStartedParams data = ServiceManagerListenerOnServiceStartedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_SERVICE_PID_RECEIVED_ORDINAL: {
                        ...
                        ServiceManagerListenerOnServicePidReceivedParams data = ServiceManagerListenerOnServicePidReceivedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_SERVICE_FAILED_TO_START_ORDINAL: {
                        ...
                        ServiceManagerListenerOnServiceFailedToStartParams data = ServiceManagerListenerOnServiceFailedToStartParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case ON_SERVICE_STOPPED_ORDINAL: {
                        ...
                        ServiceManagerListenerOnServiceStoppedParams data = ServiceManagerListenerOnServiceStoppedParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), ServiceManagerListener_Internal.MANAGER, messageWithHeader, receiver);
