...
public interface IJsSandboxIsolateSyncCallback extends android.os.IInterface {
     ...
     */
    class Default implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateSyncCallback {
        /**
     ...
     */
    abstract class Stub extends android.os.Binder implements org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateSyncCallback {
        /**
    ...
    java.lang.String DESCRIPTOR = "org.chromium.android_webview.js_sandbox.common.IJsSandboxIsolateSyncCallback";
    // An exception was thrown during the JS evaluation.
    int JS_EVALUATION_ERROR = 0;
    // The evaluation failed and the isolate crashed due to running out of heap memory.
    int MEMORY_LIMIT_EXCEEDED = 1;
    // The evaluation failed due to IO errors while reading from the file descriptor.
    int FILE_DESCRIPTOR_IO_ERROR = 2;

    /**
     * @param afd input AssetFileDescriptor containing the return value of JS evaluation
     */
    void reportResultWithFd(android.content.res.AssetFileDescriptor afd) throws android.os.RemoteException;

    /**
     * @param errorType denotes the type of error. Should be one of the constants in this file
     * @param afd       input AssetFileDescriptor containing the returned error of the JS evaluation
     */
    void reportErrorWithFd(int errorType, android.content.res.AssetFileDescriptor afd) throws android.os.RemoteException;
