...
public final class VideoCaptureFeedback extends org.chromium.mojo.bindings.Struct {
    ...
    public org.chromium.gfx.mojom.Size[] deprecatedMappedSizes;
    public int frameId;
            ...
            if (elementsOrVersion >= 1) {
                {
                    ...
                    if (decoder1 == null) {
                        ...
                        result.deprecatedMappedSizes = new org.chromium.gfx.mojom.Size[si1.elementsOrVersion];
                        for (int i1 = 0; i1 < si1.elementsOrVersion; ++i1) {

                            org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i1, false);
                            result.deprecatedMappedSizes[i1] = org.chromium.gfx.mojom.Size.decode(decoder2);
                        }
                    }
                }
            }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.deprecatedMappedSizes == null) {
            encoder0.encodeNullPointer(32, true);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.deprecatedMappedSizes.length, 32, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
            for (int i0 = 0; i0 < this.deprecatedMappedSizes.length; ++i0) {

                encoder1.encode(this.deprecatedMappedSizes[i0], org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE * i0, false);
            }
        }
    }
}