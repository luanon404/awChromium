...
int constraints, int current, boolean animate) {
            ...
            WidgetInputHandlerUpdateBrowserControlsStateParams _message = new WidgetInputHandlerUpdateBrowserControlsStateParams();
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case UPDATE_BROWSER_CONTROLS_STATE_ORDINAL: {
                        ...
                        WidgetInputHandlerUpdateBrowserControlsStateParams data =
                                WidgetInputHandlerUpdateBrowserControlsStateParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class WidgetInputHandlerDispatchEventResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WidgetInputHandlerDispatchEventResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new WidgetInputHandlerDispatchEventResponseParams(elementsOrVersion);
                    ...
                    result.scrollResultData = ScrollResultData.decode(decoder1);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.scrollResultData, 40, true);
        }
    }
    ...
    static class WidgetInputHandlerDispatchEventResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                mCallback.call(response.source, response.updatedLatency, response.state, response.overscroll, response.touchAction, response.scrollResultData);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class WidgetInputHandlerDispatchEventResponseParamsProxyToResponder implements WidgetInputHandler.DispatchEvent_Response {
        ...
        @Override
        public void call(Integer source, org.chromium.ui.mojom.LatencyInfo updatedLatency, Integer state, DidOverscrollParams overscroll, TouchActionOptional touchAction, ScrollResultData scrollResultData) {
            ...
            _response.scrollResultData = scrollResultData;
    ...
    static final class WidgetInputHandlerUpdateBrowserControlsStateParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static WidgetInputHandlerUpdateBrowserControlsStateParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static WidgetInputHandlerUpdateBrowserControlsStateParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static WidgetInputHandlerUpdateBrowserControlsStateParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            ...
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new WidgetInputHandlerUpdateBrowserControlsStateParams(elementsOrVersion);
                    {
