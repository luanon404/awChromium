...
public class PropertyModelChangeProcessor<M extends PropertyObservable<P>, V, P> {
     ...
     */
    private PropertyModelChangeProcessor(M model, V view, ViewBinder<M, V, P> viewBinder, boolean performInitialBind) {
        mModel = model;
        mView = view;
     ...
     * @param viewBinder A class that binds the model to the view.
     */
    public static <M extends PropertyObservable<P>, V, P> PropertyModelChangeProcessor<M, V, P> create(M model, V view, ViewBinder<M, V, P> viewBinder) {
     ...
     * @param performInitialBind Whether all set model properties should be immediately bound.
     */
    public static <M extends PropertyObservable<P>, V, P> PropertyModelChangeProcessor<M, V, P> create(M model, V view, ViewBinder<M, V, P> viewBinder, boolean performInitialBind) {
