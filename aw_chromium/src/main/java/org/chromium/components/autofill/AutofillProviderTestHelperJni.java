...
class AutofillProviderTestHelperJni implements AutofillProviderTestHelper.Natives {
  ...
  public static final JniStaticTestMocker<AutofillProviderTestHelper.Natives> TEST_HOOKS =
      new JniStaticTestMocker<AutofillProviderTestHelper.Natives>() {
    @Override
    ...
    if (GEN_JNI.TESTING_ENABLED) {
      ...
      if (GEN_JNI.REQUIRE_MOCK) {
        throw new UnsupportedOperationException(
            "No mock found for the native implementation of AutofillProviderTestHelper.Natives. "
