...
class DataPipeGetter_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<DataPipeGetter, DataPipeGetter.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<DataPipeGetter, DataPipeGetter.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements DataPipeGetter.Proxy {
        ...
        @Override
        public void read(org.chromium.mojo.system.DataPipe.ProducerHandle pipe, Read_Response callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(READ_ORDINAL, org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG, 0)), new DataPipeGetterReadResponseParamsForwardToCallback(callback));

        }


        @Override
        public void clone(org.chromium.mojo.bindings.InterfaceRequest<DataPipeGetter> receiver) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(DataPipeGetter_Internal.MANAGER, messageWithHeader);
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), DataPipeGetter_Internal.MANAGER, messageWithHeader, receiver);
    ...
    static class DataPipeGetterReadResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable implements org.chromium.mojo.bindings.MessageReceiver {
    ...
    static class DataPipeGetterReadResponseParamsProxyToResponder implements DataPipeGetter.Read_Response {
        ...
        DataPipeGetterReadResponseParamsProxyToResponder(org.chromium.mojo.system.Core core, org.chromium.mojo.bindings.MessageReceiver messageReceiver, long requestId) {
            mCore = core;
