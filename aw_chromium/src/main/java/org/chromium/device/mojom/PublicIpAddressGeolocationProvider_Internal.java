// PublicIpAddressGeolocationProvider_Internal.java is auto generated by mojom_bindings_generator.py, do not edit
...
class PublicIpAddressGeolocationProvider_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<PublicIpAddressGeolocationProvider, PublicIpAddressGeolocationProvider.Proxy> MANAGER = new org.chromium.mojo.bindings.Interface.Manager<PublicIpAddressGeolocationProvider, PublicIpAddressGeolocationProvider.Proxy>() {
    ...
    static final class Proxy extends org.chromium.mojo.bindings.Interface.AbstractProxy implements PublicIpAddressGeolocationProvider.Proxy {
        ...
        @Override
        public void createGeolocation(org.chromium.network.mojom.MutablePartialNetworkTrafficAnnotationTag tag, org.chromium.mojo.bindings.InterfaceRequest<Geolocation> receiver) {
            ...
            getProxyHandler().getMessageReceiver().accept(_message.serializeWithHeader(getProxyHandler().getCore(), new org.chromium.mojo.bindings.MessageHeader(CREATE_GEOLOCATION_ORDINAL)));
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_OR_CLOSE_PIPE_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRunOrClosePipe(PublicIpAddressGeolocationProvider_Internal.MANAGER, messageWithHeader);


                    case CREATE_GEOLOCATION_ORDINAL: {

                        PublicIpAddressGeolocationProviderCreateGeolocationParams data = PublicIpAddressGeolocationProviderCreateGeolocationParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case org.chromium.mojo.bindings.interfacecontrol.InterfaceControlMessagesConstants.RUN_MESSAGE_ID:
                        return org.chromium.mojo.bindings.InterfaceControlMessagesHelper.handleRun(getCore(), PublicIpAddressGeolocationProvider_Internal.MANAGER, messageWithHeader, receiver);
